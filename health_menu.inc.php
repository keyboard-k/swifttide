...
?>" title="<?php echo _HEALTH_MENU_INC_ALL?>"><?php echo _HEALTH_MENU_INC_ALL_TEXT?></a></td></tr>
	...
	<!--
	<tr><td><a href="health_chat.php" title="<?php echo _HEALTH_MENU_INC_CHAT?>"><?php echo _HEALTH_MENU_INC_CHAT_TEXT?></a></td></tr>
	-->
	...
	<tr><td><a href="admin_student_1.php" title="<?php echo _HEALTH_MENU_INC_ADMIN_AREA?>"><?php echo _HEALTH_MENU_INC_ADMIN_AREA_TEXT?></a></td></tr>
	-->
	</table></table>
</div>
