...
function submitform()
{
  ...
  if (x != ""){
	  alert('<? echo _ADMIN_ADD_STUDENT_3_ENTER_ALL?>');
	  return false;
  }
  else{
	  return true;
...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_ADD_STUDENT_3_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	if ($msgFormErr!=""){
	?>
	   <h1><? echo _ADMIN_ADD_STUDENT_3_TITLE?></h1>
	   <br>
	   <h2><? echo _ADMIN_ADD_STUDENT_3_ERROR_BACK?></h2>
	   <br>
	   <h3><? echo $msgFormErr; ?></h3>
	<?
	}else{
	?>
	   <h1><? echo _ADMIN_ADD_STUDENT_3_TITLE_SUCCESS?></h1>
	   <br>
	   <h2><? echo _ADMIN_ADD_STUDENT_3_STUDENT?>: <? echo $sfname." ".$slname; ?></h2>
	   <br>
	   <h2><? echo _ADMIN_ADD_STUDENT_3_CONTACT?>: <? echo $cfname." ".$clname; ?></h2>
	   <br>
	   <p class="ltext"><? echo _ADMIN_ADD_STUDENT_3_MESSAGE?></p>
	   <form name="addwebuser" method="POST" action="admin_add_contact_user.php" onsubmit="return submitform();">
	   <p class="ltext"><? echo _ADMIN_ADD_STUDENT_3_EMAIL?>:&nbsp;
	   <input type="text" onchange="this.value=this.value.toLowerCase();" name="email" value="<? echo $email; ?>" size="35"><br><br>
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? echo _ADMIN_ADD_STUDENT_3_USERNAME?>:&nbsp;<input type="text" onchange="this.value=this.value.toLowerCase();" name="username" size="10">&nbsp;
	   <? echo _ADMIN_ADD_STUDENT_3_PASSWORD?>:&nbsp;<input type="text" onchange="this.value=this.value.toLowerCase();" name="password" size="10"></p>
	   <input type="submit" name="submit" value="<? echo _ADMIN_ADD_STUDENT_3_SET?>" class="frmbut">
	   ...
	   <a href="admin_add_edit_contact_1.php?studentid=<? echo $studentid; ?>&action=add" class="aform"><? echo _ADMIN_ADD_STUDENT_3_ADD_NEW?></a>
	<br>
	   <a href="admin_add_student_1.php"><? echo _ADMIN_ADD_STUDENT_3_ADD?></a>
	<?
	};
	?>
</div>
