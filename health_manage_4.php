...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _HEALTH_MANAGE_4_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
  <h1><?php echo _ERROR?></h1>
   <br>
   <h2><?php echo _HEALTH_MANAGE_4_ERROR_BACK?>Please use your browser 'back' button to correct the following error(s):</h2>
   <br>
