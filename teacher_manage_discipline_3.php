...
<div id="Content">
	...
	<br>
	<h2><?php echo _TEACHER_MANAGE_DISCIPLINE_3_INSERTED?><?php echo $user; ?></h2>
	...
	<tr><td colspan=2><table width="100%"> <?php
		...
		foreach($custom_discipline_fields as $custom_discipline_field) {
			...
			?>]"><option value="0"><?php echo _TEACHER_MANAGE_DISCIPLINE_3_DELETE?>...</option><?php
	...
	<option value="0" selected><?php echo _TEACHER_MANAGE_DISCIPLINE_3_NEW?>...</option><?php
	foreach($custom_fields as $custom_field) {
