...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_EXAMS_TYPES_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	if ($action != "edit"){
		...
		<form name="manage_exams_types" method="post" action="<?echo($_SERVER['PHP_SELF']);?>">						
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="name" size="20">&nbsp;<A class="aform" href="javascript: submitform('name')"><?php echo _ADMIN_EXAMS_TYPES_ADD?></a>
	...
	?>
		...
		<form name="edit_exams_types" method="post" action="<?echo($_SERVER['PHP_SELF']);?>">
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="name" size="20" value="<?echo ($name);?>">&nbsp;<A class="aform" href="javascript: submitform('name')"><?php echo _ADMIN_EXAMS_TYPES_UPDATE?></a>
