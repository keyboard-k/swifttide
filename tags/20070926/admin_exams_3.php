...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_EXAMS_3_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_EXAMS_3_TITLE?></h1>
	<br>

        <table border="1" cellpadding="0" cellspacing="0" width="100%">
	<form name="exam" method="POST" action="admin_exams_4.php">
	  <tr class="trform">
	    <td width="35%">&nbsp;<?php echo _ADMIN_EXAMS_3_YEAR?></td>
	    <td width="30%">&nbsp;<?php echo _ADMIN_EXAMS_3_SCHOOL?></td>
	    <td width="35%">&nbsp;<?php echo _ADMIN_EXAMS_3_ROOM?></td>
	  </tr>
	<tr class="tblcont">
...
<?php }; ?>
	...
	<tr class="tblhead">
	  <td width="35%">&nbsp;<?php echo _ADMIN_EXAMS_3_DATE?></td>
	  <td width="30%">&nbsp;<?php echo _ADMIN_EXAMS_3_SUBJECT?></td>
...
<?php }; ?>
	...
	<tr class="tblhead">
	  <td colspan="3" width="100%">&nbsp;<?php echo _ADMIN_EXAMS_3_TEACHER?></td>
	</tr>
	<tr class="tblcont">
