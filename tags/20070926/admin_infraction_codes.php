...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_INFRACTION_CODES_UPPER?>
    </td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	?>
		...
		<form name="editinfraction" method="post" action="admin_infraction_codes.php">						
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="infractionname" size="20" value="<?php echo $infraction_codes_desc; ?>">&nbsp;<A class="aform" href="javascript: submitform('infractionname')"><?php echo _ADMIN_INFRACTION_CODES_UPDATE?></a>
