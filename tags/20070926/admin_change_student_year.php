...
function confirmchange(id) {
	var answer;	
	answer = window.confirm("<?php echo _ADMIN_CHANGE_STUDENT_YEAR_CONFIRM?>");
	if (answer == 1) {
		var url;
...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_CHANGE_STUDENT_YEAR_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_CHANGE_STUDENT_YEAR_TITLE?></h1>
	<br>
	<p class="ltext"><?php echo _ADMIN_CHANGE_STUDENT_YEAR_SELECT?>:</p><br>
	<?php
