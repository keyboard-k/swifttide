...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php  echo _NURSE_INFO_3_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php  echo _NURSE_INFO_3_TITLE?></h1>
	<br>
	...
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
		  <tr class="tblhead">
		    <td width="34%">&nbsp;<?php  echo _NURSE_INFO_3_DOB?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_SCHOOL?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_GRADE?></td>
		  </tr>
		  <tr class="tblcont">
		  ...
		  <tr class="tblhead">
		    <td width="34%">&nbsp;<?php  echo _NURSE_INFO_3_HOME?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_TEACHER?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_ROUTE?></td>
		  </tr>
		  <tr class="tblcont">
		...
		<p><h2><?php  echo _NURSE_INFO_3_PRIMARY?></h2>
		<table border="1" cellpadding="0" cellspacing="0" width="100%">
		  <tr class="tblcont">
			...
			<?php  if ($primcontinfo->contact_to_students_residence==1){echo " <font color=#FF0000><b>" . _NURSE_INFO_3_RESIDENCE . "</b></font>";}; ?>
			</td>
		  </tr>
		  <tr class="tblhead">
		    <td width="100%" colspan="3">&nbsp;<?php  echo _NURSE_INFO_3_ADDRESS?></td>
		  </tr>
		  <tr class="tblcont">
		    <td width="100%" colspan="3">&nbsp;<?php  echo $primcontinfo->studentcontact_address1 . " " . $primcontinfo->studentcontact_address2 ;?> </td>
		  </tr>
		  <tr class="tblhead">
		    <td width="34%">&nbsp;<?php  echo _NURSE_INFO_3_CITY?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_STATE?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_ZIP?></td>
		  </tr>
		  <tr class="tblcont">
		  ...
		  <tr class="tblhead">
		    <td width="34%">&nbsp;<?php  echo _NURSE_INFO_3_PHONE1?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_PHONE2?></td>
		    <td width="33%">&nbsp;<?php  echo _NURSE_INFO_3_PHONE3?></td>
		  </tr>
		  <tr class="tblcont">
...
<body>
<div id="Content">
	<h2><?php  echo _NURSE_INFO_3_MED_INFO?></h2>
	<?php 
	$ezr->display();
	?>
...
<div id="Content">
	<h2><?php  echo _NURSE_INFO_3_ALL_INFO?></h2>
	<?php 
	$ezr->display();
	?>
	<table border="0" cellpadding="0" cellspacing="0" width="70%">
...
<div id="Content">
	<h2><?php  echo _NURSE_INFO_3_IMM_INFO?></h2>
	<?php 
	$ezr->display();
	?>
	<table border="0" cellpadding="0" cellspacing="0" width="70%">
...
<body>
<div id="Content">
	<h2><?php  echo _NURSE_INFO_3_HEALTH_INFO?></h2>
	<?php 
	$ezr->display();
	?>
	<table border="0" cellpadding="0" cellspacing="0" width="70%">
