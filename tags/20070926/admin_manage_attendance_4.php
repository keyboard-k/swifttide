...
//			$mail->Password = SMTP_PASSWORD; // SMTP password
			...
			$mail->Subject  = _ADMIN_MANAGE_ATTENDANCE_4_SUBJECT . $sfname." ".$slname; 
			$mail->Body = _ADMIN_MANAGE_ATTENDANCE_4_BODY1 . $sfname." ".$slname . _ADMIN_MANAGE_ATTENDANCE_4_BODY2;
			$mio=$mail->Send();
		};
	};
	...
	$url="admin_manage_attendance_1.php?studentid=".$studentid;
	header("Location: $url");
	exit();
};
?>
