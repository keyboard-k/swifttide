...
function cnfremove(id) {
	var answer;	
	answer = window.confirm("<?php echo _ADMIN_USERS_3_SURE?>");
	if (answer == 1) {
		var url;
...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_USERS_3_ADMIN_AREA?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_USERS_3_ETH?></h1>
	<br>
	<?php
	if ($action!="edit"){
		...
		<form name="addethnicity" method="post" action="admin_ethnicity.php">						
		  <p class="pform"><?php echo _ADMIN_USERS_3_ADD_NEW?><br>
	      <input type="text" onChange="capitalizeMe(this)" name="ethnicityname" size="20">&nbsp;<A class="aform" href="javascript: submitform('ethnicityname')"><?php echo _ADMIN_USERS_3_ADD?></a>
	...
	?>
		...
		<form name="editethnicity" method="post" action="admin_ethnicity.php">						
		  <p class="pform"><?php echo _ADMIN_USERS_3_UPDATE_ETH?><br>
	      <input type="text" onChange="capitalizeMe(this)" name="ethnicityname" size="20" value="<?php echo $ethnicity_desc; ?>">&nbsp;<A class="aform" href="javascript: submitform('ethnicityname')"><?php echo _ADMIN_USERS_3_UPDATE?></a>
