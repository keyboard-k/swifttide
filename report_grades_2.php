...
$q = "SELECT * from grade_history, studentbio, ethnicity, school_names, school_years 
...
$q .= " ORDER BY studentbio.studentbio_id, $sorted_1";
...
//Instanciation of inherited class
	...
	foreach($r as $s) {
		...
		if($current_student != $previous_student) {
			...
			$head = array(_REPORT_GRADES_2_HEADER_SUBJECT,
				      _REPORT_GRADES_2_HEADER_QUARTER,
				      _REPORT_GRADES_2_HEADER_GRADE,
				      _REPORT_GRADES_2_HEADER_EFFORT,
				      _REPORT_GRADES_2_HEADER_CONDUCT);
			$pdf->PrintRow($head);
		}
	...
	echo"<center><h1>" . _REPORT_GRADES_2_NONE . "</h2></center>";
}
