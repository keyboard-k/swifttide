...
// health_immunz_3.php
// Health Section
// Edit Immunization Information for student
//*
...
health_immunz_history.health_immunz_history_action, 
...
$healthcodes=$db->get_results("SELECT * FROM health_immunz ORDER BY 
health_immunz_desc");
