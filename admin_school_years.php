...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_SCHOOL_YEARS_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	if ($action!="edit"){
		...
		<form name="addyear" method="post" action="admin_school_years.php">						
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="schoolyear" size="20">&nbsp;<A class="aform" href="javascript: submitform('schoolyear');"><?php echo _ADMIN_SCHOOL_YEARS_ADD?></a>
