...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_USERS_2_ADMIN_AREA?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><? echo $human ?> <? echo _ADMIN_USERS_2_SEARCH_RESULTS?></h1>
	<br>
	<?
	...
	?>
	<br>
	<A class="aform" href="admin_users_1.php"><? echo _ADMIN_USERS_2_NEW?></a>
</div>
