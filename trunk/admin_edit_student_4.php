...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_EDIT_STUDENT_4_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	   <h1><? echo _ADMIN_EDIT_STUDENT_4_TITLE?></h1>
	   <br>
	   <h3><? echo $msgFormErr ; ?></h2>
	   <br>
	   <h2><? echo _ADMIN_EDIT_STUDENT_4_ERROR_BACK?></h2>
	   <br>
	   <a href="admin_edit_student_1.php?studentid=<? echo $studentid; ?>" class="aform"><? echo _ADMIN_EDIT_STUDENT_4_BACK?></a>
</div>
