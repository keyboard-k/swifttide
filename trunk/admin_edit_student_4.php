...
if (!strlen($msgFormErr)){
	...
	if ($dblid=$db->get_row($sSQL)){
		...
		$sSQL="UPDATE studentbio 
		SET studentbio_internalid='$internalid', 
studentbio_active='".$active."', 
studentbio_lname=".$slname.", 
studentbio_fname=".$sfname.", 
studentbio_mi='".$mi."', 
studentbio_generation='".$generation."', 
studentbio_sped='".$sped."', 
studentbio_gender='".$gender."', 
studentbio_ethnicity='".$ethnicity."', 
studentbio_dob='".$dob."', 
studentbio_birthcity=".$bcity.", 
studentbio_birthstate=".$bstate.", 
studentbio_birthcountry=".$bcountry.", 
studentbio_prevschoolname=".$pschoolname.", 
studentbio_prevschooladdress=".$pschooladdress.", 
studentbio_prevschoolcity=".$pschoolcity.", 
studentbio_prevschoolstate=".$pschoolstate.", 
studentbio_prevschoolzip=".$pschoolzip.", 
studentbio_prevschoolcountry=".$pschoolcountry.", 
studentbio_school='".$school."', 
studentbio_homed='".$homed."', 
studentbio_teacher='".$teacher."', 
studentbio_homeroom=".$homeroom.", 
studentbio_bus=".$bus." 
