...
function validateHomework(homework_form_name) {
	...
	if(!f.subjectid.value || f.subjectid.value == '') {
		alert("<?php echo _TEACHERS_HOMEWORK_ENTER_SUBJECT?>");
		return false;
	}
	if(!f.date_assigned.value || f.date_assigned.value == '') {
		alert("<?php echo _TEACHERS_HOMEWORK_ENTER_DATE?>");
		return false;
	}
	if(!f.date_due.value || f.date_due.value == '') {
		alert("<?php echo _TEACHERS_HOMEWORK_ENTER_DUE_DATE?>");
		return false;
	}
...
function deleteHomework(homework_form_name) {
	...
	var f = eval("document.forms." + homework_form_name);
	if(confirm("<?php echo _TEACHERS_HOMEWORK_DELETE?>")) {
...
function addHomeworkFile(homework_form_name) {
	...
	if(!f.new_homework_file_title.value || f.new_homework_file_title.value == "") {
		alert("<?php echo _TEACHERS_HOMEWORK_FILE_TITLE?>");
		return false;
	}
	if(!f.new_homework_file.value || f.new_homework_file.value == "") {
		alert("<?php echo _TEACHERS_HOMEWORK_FILE_INVALID?>");
		return false;
	}
...
function deleteHomeworkFile(homework_form_name, homework_file_id) {
	if(confirm("<?php echo _TEACHERS_HOMEWORK_DELETE_FILE?>")) {
		var f = eval("document.forms." + homework_form_name);
...
<div id="Content">
<h1><?php echo _TEACHERS_HOMEWORK_TITLE?></h1>
<br>
...
<table border=1><th><?php echo _TEACHERS_HOMEWORK_NEW_TITLE?></th><tr><td><table>

<tr><td><table>
<tr>
  <td class="trtblhead"><?php echo _TEACHERS_HOMEWORK_NEW_NAME?>:</td>
...
<tr><td class="trtblhead"><?php echo _TEACHERS_HOMEWORK_ASSIGNED_ON?></td>
...
<?php echo _TEACHERS_HOMEWORK_DUE_ON?></td><td class="tblcont">
...
<table>
<tr><td align="center" class="trtblhead"><?php echo _TEACHERS_HOMEWORK_NOTES?></td></tr>
<tr><td>
...
<input name="add_homework" type="Submit" class="frmbut" onClick="javascript:return validateNewHomework()" value="<?php echo _TEACHERS_HOMEWORK_ADD?>">
</td></tr>
...
if(is_array($homework)) {
	...
	foreach($homework as $assignment) {
		...
		onClick="javascript: deleteHomework('homework_<?echo($assignment->homework_id);?>')" value="<?php echo _TEACHERS_HOMEWORK_DEL_ASSIGNMENT?>">
		...
		<? //homework files
			...
			<td class="trtblhead">
		<?php echo _TEACHERS_HOMEWORK_FILES_TITLE?>:</td><td><input type="text" name="new_homework_file_title"></td><td class="trtblhead">
		<?php echo _TEACHERS_HOMEWORK_FILES_LOCATION?>: <input name="new_homework_file" type="file"></td><td>
		<input name="add_homework_file" type="submit" class="frmbut" 
		onClick="javascript: return addHomeworkFile('homework_<?echo($assignment->homework_id);?>')"  value="<?php echo _TEACHERS_HOMEWORK_FILES_ADD?>">
		</td></tr><?php
		...
		if(is_array($homework_files)) {
			foreach($homework_files as $homework_file) {
				...
				onClick="javascript: return deleteHomeworkFile('homework_<?echo($assignment->homework_id);?>', '<?echo($homework_file->homework_file_id);?>')" value="<?php echo _TEACHERS_HOMEWORK_FILES_DELETE?>"></td></tr><?php
			}
		}
		?></table></td></tr><?php
