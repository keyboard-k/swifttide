...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_GRADES_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	<br>
	<h2><?php echo _ADMIN_GRADES_SUBTITLE?></h2>
	<?php
	if ($action!="edit"){
	...
	?>
		...
		<form name="editgrade" method="post" action="admin_grades.php">	
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="gradename" size="20" value="<?php echo $grades_desc; ?>">&nbsp;<A class="aform" href="javascript: submitform('gradename')"><?php echo _ADMIN_GRADES_UPDATE?></a>
