...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_ADD_EDIT_CONTACT_5_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	   <h1><?php echo _ADMIN_ADD_EDIT_CONTACT_5_EDIT?> <?php echo $type;?> <?php echo _ADMIN_ADD_EDIT_CONTACT_5_CFS?></h1>
	   <br>
	   ...
	   <table border="0" cellpadding="1" cellspacing="1" width="100%">
		...
		<form name="addcontact" method="POST" action="admin_add_edit_contact_6.php">
	      <td width="100%">
	          <table border="1" cellpadding="0" cellspacing="0" width="100%">
	            <tr class="trform">
	              <td width="15%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_P_TITLE?></td>
	              <td width="35%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_FIRST?></td>
	              <td width="35%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_LAST?></td>
	              <td width="15%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_RESIDENCE?></td>
	            </tr>
	            <tr>
	              ...
	              <td width="35%" class="tdinput">
	                  <input type="text" onChange="capitalizeMe(this)" name="cfname" size="25" <?php echo " value=\"".strip($contact->studentcontact_fname)."\""; ?>>
	              </td>
		          <td width="35%" class="tdinput">
		...
		<tr>
	      <td width="100%">
	          <table border="1" cellpadding="0" cellspacing="0" width="100%">
	            <tr class="trform">
	              <td width="20%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_RELATION?></td>
	              <td width="40%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_ADDRESS?></td>
		          <td width="40%">&nbsp;</td>
				</tr>
				<tr>
		          ...
		          <td width="40%" class="tdinput">
				    <input type="text" onChange="capitalizeMe(this)" name="address1" size="40" <?php echo " value=\"".strip($contact->studentcontact_address1)."\""; ?>>
	              </td>
		          <td width="40%" class="tdinput">
					<input type="text" onChange="capitalizeMe(this)" name="address2" size="40" <?php echo " value=\"".strip($contact->studentcontact_address2)."\""; ?>>
		          </td>
	            </tr>
	          </table>
		  </td>
		...
		<tr>
	      <td width="100%">
	          <table border="1" cellpadding="0" cellspacing="0" width="100%">
	            <tr class="trform">
	              <td width="35%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_CITY?></td>
	              <td width="10%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_STATE?></td>
		          <td width="10%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_ZIP?></td>
				  <td width="45%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_EMAIL?></td>
				</tr>
				<tr>
	              <td width="35%" class="tdinput">
					<input type="text" onChange="capitalizeMe(this)" name="city" size="20" <?php echo " value=\"".strip($contact->studentcontact_city)."\""; ?>>
		          </td>
		          ...
		          <td width="10%" class="tdinput">
					<input type="text" onChange="capitalizeMe(this)" name="zip" size="10" <?php echo " value=\"".strip($contact->studentcontact_zip)."\""; ?>>
		          </td>
		          <td width="45%" class="tdinput">
					<input type="text" onchange="this.value=this.value.toLowerCase();" name="email" size="50" <?php echo " value=\"".strip($contact->studentcontact_email)."\""; ?>>
		          </td>
	            </tr>
	          </table>
		  </td>
		...
		<tr>
	      <td width="100%">
	          <table border="1" cellpadding="0" cellspacing="0" width="100%">
	            <tr class="trform">
	              <td width="30%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_PHONE1?></td>
	              <td width="30%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_PHONE2?></td>
		          <td width="30%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_PHONE3?></td>
				  <td width="10%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_MAILINGS?></td>
				</tr>
				<tr>
	              <td width="30%" class="tdinput">
					<input type="text" onChange="capitalizeMe(this)" name="phone1" size="20" <?php echo " value=\"".strip($contact->studentcontact_phone1)."\""; ?>>
		          </td>
		          <td width="30%" class="tdinput">
				    <input type="text" onChange="capitalizeMe(this)" name="phone2" size="20" <?php echo " value=\"".strip($contact->studentcontact_phone2)."\""; ?>>
	              </td>
		          <td width="30%" class="tdinput">
		...
		<tr>
	      <td width="100%">
	          <table border="1" cellpadding="0" cellspacing="0" width="100%">
	            <tr class="trform">
	              <td width="100%">&nbsp;<?php echo _ADMIN_ADD_EDIT_CONTACT_5_OTHER?></td>
				</tr>
				<tr>
	              <td width="30%" class="tdinput" align="center">
					<textarea name="other" cols="40" rows="5"><?php echo strip($contact->studentcontact_other); ?></textarea>
		          </td>
	            </tr>
	          </table>
		  </td>
    ...
    <tr>
      <td width="100%">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		  <tr>
		    <td width="50%"><a href="admin_edit_student_1.php?studentid=<?php echo $studentid; ?>" class="aform"><?php echo _ADMIN_ADD_EDIT_CONTACT_5_BACK?></a>
			</td>
			<td width="50%" align="right">
			   <input type="submit" name="sumbit" value="<?php echo _ADMIN_ADD_EDIT_CONTACT_5_UPDATE?>" class="frmbut">
			</td>
		  </tr>
	   </table>
	   <input type="hidden" name="contactid" value="<?php echo $contactid; ?>">	
	   <input type="hidden" name="studentid" value="<?php echo $studentid; ?>">	   
	   <input type="hidden" name="contacttostudentsid" value="<?php echo $contacttostudentsid ?>">	   
	  </td>
    </tr>
  </form>
</table>
