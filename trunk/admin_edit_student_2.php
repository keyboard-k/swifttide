...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_EDIT_STUDENT_2_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_EDIT_STUDENT_2_TITLE?></h1>
	<br>
	<h2><?php echo $sfname . " " . $slname; ?></h2>
	<br>
		<h2><?php echo _ADMIN_EDIT_STUDENT_2_CONTACT?></h2>
		<table border="1" cellpadding="0" cellspacing="0" width="100%">
		  ...
		  <tr class="tblhead">
		    <td width="100%" colspan="3">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_ADDRESS?></td>
		  </tr>
		  <tr class="tblcont">
		    <td width="100%" colspan="3">&nbsp;<?php echo $continfo->studentcontact_address1 . " " . $continfo->studentcontact_address2 ;?> </td>
		  </tr>
		  <tr class="tblhead">
		    <td width="34%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_CITY?></td>
		    <td width="33%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_STATE?></td>
		    <td width="33%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_ZIP?></td>
		  </tr>
		  <tr class="tblcont">
		  ...
		  <tr class="tblhead">
		    <td width="34%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_PHONE1?></td>
		    <td width="33%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_PHONE2?></td>
		    <td width="33%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_PHONE3?></td>
		  </tr>
		  <tr class="tblcont">
		  ...
		  <tr class="tblhead">
		    <td width="67%" colspan="2">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_EMAIL?></td>
		    <td width="33%">&nbsp;<?php echo _ADMIN_EDIT_STUDENT_2_WEB_USER?></td>
		  </tr>
		  <tr class="tblcont">
	...
	<a href="admin_edit_student_1.php?studentid=<?php echo $studentid; ?>" class="aform"><?php echo _ADMIN_EDIT_STUDENT_2_BACK?></a>
</div>
