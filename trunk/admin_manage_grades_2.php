...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_MANAGE_GRADES_2_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><? echo _ADMIN_MANAGE_GRADES_2_TITLE?></h1>
	<br>
	<h2><? echo $grade->studentbio_fname. " " .$grade->studentbio_lname; ?></h2>
	<br>
	<h2><? echo _ADMIN_MANAGE_GRADES_2_INSERTED?><? echo $grade->web_users_flname; ?></h2>
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_SCHOOL?></td>
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_YEAR?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_QUARTER?></td>
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_GRADE?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="50%">&nbsp;<? echo $grade->grade_history_quarter ; ?></td>
		<td width="50%">&nbsp;<? echo $grade->grade_history_grade ; ?></td>
	  </tr>
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_EFFORT?></td>
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_CONDUCT?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_COMMENTS?></td>
	    <td width="50%">&nbsp;</td>
	  </tr>
	  <tr class="tblcont">
	 ...
	 <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<? echo _ADMIN_MANAGE_GRADES_2_NOTES?></td>
	  </tr>
	  <tr class="tblcont">
	...
	<? //display custom fields added by Joshua
     if(count($custom_grade_fields)) {
		?><tr><td colspan=2><h2><? echo _ADMIN_MANAGE_GRADES_2_CUSTOM_FIELDS?></h2></td></tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    <td width="50%"><a href="admin_edit_student_1.php?studentid=<? echo $studentid; ?>" class="aform"><? echo _ADMIN_MANAGE_GRADES_2_BACK?></a></td>
	    <td width="50%" align="right"><a href="admin_manage_grades_3.php?studentid=<? echo $studentid; ?>&gradeid=<? echo $gradeid; ?>&action=edit" class="aform"><? echo _ADMIN_MANAGE_GRADES_2_EDIT?></a></td>
	  </tr>
	</table>
</div>
