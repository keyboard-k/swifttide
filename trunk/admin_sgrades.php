...
function cnfremove(id) {
	var answer;	
	answer = window.confirm("<? echo _ADMIN_SGRADES_SURE?>");
	if (answer == 1) {
		var url;
...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_SGRADES_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><? echo _ADMIN_SGRADES_TITLE?></h1>
	<br>
	<?
	if ($action!="edit"){
		...
		<form name="addgrade" method="post" action="admin_sgrades.php">	
		  <p class="pform"><? echo _ADMIN_SGRADES_ADD_NEW?><br>
	      <input type="text" name="gradename" size="50" maxlength="80">&nbsp;<A class="aform" href="javascript: submitform('gradename')"><? echo _ADMIN_SGRADES_ADD?></a>
	...
	?>
		...
		<form name="editethnicity" method="post" action="admin_sgrades.php">						
		  <p class="pform"><? echo _ADMIN_SGRADES_UPDATE_COMMENT?><br>
	      <input type="text" name="gradename" size="50" maxlength="80" value="<? echo $grade_desc; ?>">&nbsp;<A class="aform" href="javascript: submitform('gradename')"><? echo _ADMIN_SGRADES_UPDATE?></a>
	      <input type="hidden" name="action" value="update">
		  <input type="hidden" name="id" value="<? echo $grade_id; ?>">
	      </p>
	    </form>
	<?
	};
