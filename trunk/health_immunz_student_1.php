...
//*
//Version 1.01 April 27,2005
//v1.02 May 1,2005.  various little fixes
...
if(!strlen($studentid)){
	$msgFormErr=_HEALTH_IMMUNZ_STUDENT_1_FORM_ERROR . "<br>";
}else{
	//Get Student Name
	...
	//Get health_immunz history
	$sSQL="SELECT health_immunz_history.health_immunz_history_id, 
DATE_FORMAT(health_immunz_history.health_immunz_history_date, '" . _EXMS_DATE . "') as 
disdate, health_immunz.health_immunz_desc FROM health_immunz_history 
...
width=40%>" . _HEALTH_IMMUNZ_STUDENT_1_DATE . "</td><td width=40%>" . _HEALTH_IMMUNZ_STUDENT_1_IMM . "</td><td 
width=20%>" . _HEALTH_IMMUNZ_STUDENT_1_DETAILS . "</td></tr>"; 
...
align=center><a 
href=health_immunz_student_2.php?studentid=$studentid&disid=COL1 
class=aform>&nbsp;" . _HEALTH_IMMUNZ_STUDENT_1_DETAILS . "</a></td></tr>";
...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _HEALTH_IMMUNZ_STUDENT_1_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	?>
	<h1><? echo _HEALTH_IMMUNZ_STUDENT_1_TITLE?></h1>
	<br>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="70%">
	  <tr>
	    <td width="50%"><a href="nurse_info_3.php?studentid=<? echo 
$studentid; ?>" class="aform"><? echo _HEALTH_IMMUNZ_STUDENT_1_BACK?></a></td>
	    <td width="50%" align="right"><a 
href="health_immunz_student_3.php?studentid=<? echo $studentid; 
?>&action=new" 
class="aform"><? echo _HEALTH_IMMUNZ_STUDENT_1_ADD?></a></td>
	  </tr>
	</table>
	<?
	}else{
