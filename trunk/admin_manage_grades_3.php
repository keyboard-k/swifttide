	  ...
	  <tr class="tblcont">
		<td width="100%" class="tdinput" colspan="2">
			  <select name="comment1">
			   ...
			   ?>
		       <option value="<?php echo $gradecode->grade_names_id; ?>" <? if ($gradecode->grade_names_id==$grade->grade_history_comment1){echo "selected=selected";};?>><?php echo $gradecode->grade_names_desc; ?></option>
			   <?php
			   };
			   ?>
			   </select>
		...
		<td width="100%" class="tdinput" colspan="2">
			  <select name="comment2">
			   ...
			   foreach($gradecodes as $gradecode){
			   ?>
		       <option value="<?php echo $gradecode->grade_names_id; ?>" <? if ($gradecode->grade_names_id==$grade->grade_history_comment2){echo "selected=selected";};?>><?php echo $gradecode->grade_names_desc; ?></option>
			   <?php
			   };
			   ?>
			   </select>
	  ...
	  <tr class="tblcont">
	    <td width="100%" class="tdinput" colspan="2">
			  <select name="comment3">
			   ...
			   foreach($gradecodes as $gradecode){
			   ?>
		       <option value="<?php echo $gradecode->grade_names_id; ?>" <? if ($gradecode->grade_names_id==$grade->grade_history_comment3){echo "selected=selected";};?>><?php echo $gradecode->grade_names_desc; ?></option>
			   <?php
			   };
			   ?>
			   </select>
