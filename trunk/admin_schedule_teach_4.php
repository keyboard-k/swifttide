...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_SCHEDULE_TEACH_4_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><? echo _ERROR?> <? echo $msgheader; ?> <? echo _ADMIN_SCHEDULE_TEACH_4_TITLE?></h1>
	<br>
	<h2><? echo _ADMIN_SCHEDULE_TEACH_4_TITLE?></h2>
	<br>
