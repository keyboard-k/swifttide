...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _HEALTH_IMMUNZ_2_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><? echo _HEALTH_IMMUNZ_2_TITLE?></h1>
	<br>
	<h2><? echo $discipline->studentbio_fname. " " .$discipline->studentbio_lname; ?></h2>
	<br>
	<h2><? echo _HEALTH_IMMUNZ_2_INSERTED?><? echo $discipline->web_users_flname; ?></h2>
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _HEALTH_IMMUNZ_2_SCHOOL?></td>
	    <td width="50%">&nbsp;<? echo _HEALTH_IMMUNZ_2_YEAR?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _HEALTH_IMMUNZ_2_MED?></td>
	    <td width="50%">&nbsp;<? echo _HEALTH_IMMUNZ_2_DATE?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="50%">&nbsp;<? echo 
$discipline->health_immunz_desc ; ?></td>
	  ...
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<? echo _HEALTH_IMMUNZ_2_REASON?></td>
	  </tr>
	  <tr class="tblcont">
...
$discipline->health_immunzhistory_reason ;?></td>
	  ...
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<? echo _HEALTH_IMMUNZ_2_NOTES?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="100%" colspan="2">&nbsp;<? echo 
$discipline->health_immunz_history_notes ; ?></td>
	...
	<? //display custom fields added by Joshua
     if(count($custom_discipline_fields)) {
		?><tr><td colspan=2><h2><? echo _HEALTH_IMMUNZ_2_CUSTMO_FIELDS?></h2></td></tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    <td width="50%"><a href="health_immunz_1.php?studentid=<? echo 
$studentid; ?>" class="aform"><? echo _HEALTH_IMMUNZ_2_BACK?></a></td>
	    <td width="50%" align="right"><a 
href="health_immunz_3.php?studentid=<? echo $studentid; 
?>&disid=<? 
echo $disid; ?>&action=edit" class="aform"><? echo _HEALTH_IMMUNZ_2_EDIT?></a></td>
	  </tr>
	</table>
</div>
