...
<div id="Content">
	...
	if($action=="update"){
	?>
	<h1><? echo _HEALTH_CHANGE_PASSWORD_SUCCESSFUL?></h1>
	<?
	}else{
	?>
	<h1><? echo _HEALTH_CHANGE_PASSWORD_TITLE?></h1>
	<br>
	...
	<a class="aform" href="javascript: submitform('password')"><? echo _HEALTH_CHANGE_PASSWORD_UPDATE?></a>
	</form>
	<?
	};
	?>
