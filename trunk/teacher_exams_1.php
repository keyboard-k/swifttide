...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _TEACHER_EXAMS_1_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _TEACHER_EXAMS_1_TITLE?></h1>
	<br>
	<?php
	$ezr->display();
	?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	    ...
	    href="teacher_exams_3.php?action=new" class="aform"><?php echo _TEACHER_EXAMS_1_ADD?></a></td>
	</tr>
	</table>
</div>
