...
?>
      <TR>
        <TD class="hforeground" align="center">
          <B><I><?=$lng["passchanged"]?></I></B>
        </TD>
      </TR>
      <TR>
        <TD class="hforeground" align="center">
          <INPUT type="button" class="buttons" onclick="window.close();" value="<?=$lng["closewindow"]?>">
        </TD>
      </TR>
<?
...
?>
      <TR>
        <TD colspan="2" class="hforeground" align="center">
          <INPUT type="button" class="buttons" value="<?=$lng["changepass"]?>" onclick="window.open('main.php?session_id=<?=$session_id?>&include=<?=$include?>&update_password=1&profile_user_id=<?=$session->user_id?>','change_password','toolbar=no,status=no,menubar=no,scrollbars=no,resizable=yes,location=no,width=500,height=300');">
        </TD>
      </TR>
<?
}
...
?>
      <TR>
        ...
        <TD class="hforeground" align="left">
          <INPUT type="text" class="textinputs" name="color" value="#<?=$user->color?>" style="width:65px" maxlength="7">
