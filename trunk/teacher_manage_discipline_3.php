...
<div id="Content">
	<h1><?php echo _TEACHER_MANAGE_DISCIPLINE_3_TITLE?></h1>
	<br>
	<h2><? echo $sfname. " " .$slname ; ?></h2>
	<br>
	<h2><?php echo _TEACHER_MANAGE_DISCIPLINE_3_INSERTED?><? echo $user; ?></h2>
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
	<form name="discipline" method="POST" action="teacher_manage_discipline_4.php">
	  <tr class="trform">
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_3_SCHOOL?></td>
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_3_YEAR?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="trform">
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_3_INFRACTION?></td>
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_3_DATE?>Date</td>
	  </tr>
	  <tr class="tblcont">
	    <td width="50%" class="tdinput">
			  <select name="discode">
			  <option><?php echo _TEACHER_MANAGE_DISCIPLINE_3_SELECT?></option>
			   <?
	  ...
	  <tr class="trform">
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_3_START_DATE?></td>
	  ...
	  ?>
	  <tr>
	    <td width="100%" colspan="2" class="tdinput">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_3_NOTIFY?>:<input type="checkbox" name="notify" value="1" checked=checked></td>
	...
	?> <tr class="trform"><td colspan=2><?php echo _TEACHER_MANAGE_DISCIPLINE_3_CUSTOM_FIELDS?></td></tr>
	<tr><td colspan=2><table width="100%"> <?
		...
		foreach($custom_discipline_fields as $custom_discipline_field) {
			...
			?>]"><option value="0"><?php echo _TEACHER_MANAGE_DISCIPLINE_3_DELETE?>...</option><?
	...
	<option value="0" selected><?php echo _TEACHER_MANAGE_DISCIPLINE_3_NEW?>...</option><?
	foreach($custom_fields as $custom_field) {
		?><option value="<?echo($custom_field->custom_field_id);
		?>"><? echo($custom_field->name);
		?></option><?
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    <td width="50%"><a href="teacher_edit_student_1.php?studentid=<? echo $studentid; ?>" class="aform"><?php echo _TEACHER_MANAGE_DISCIPLINE_3_BACK?></a></td>
