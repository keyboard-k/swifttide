...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_CONTACT_2_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_CONTACT_2_TITLE?></h1>
	<br>
	<?php
	...
	?>
	<br>
	<a class="aform" href="admin_users_1.php"><?php echo _ADMIN_CONTACT_2_NEW?></a>
</div>
