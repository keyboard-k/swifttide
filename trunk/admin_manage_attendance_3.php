...
//v1.5 12-4-05 Fixed "note added by" to display username
//*
...
if ($action=="edit"){
	...
	attendance_history.attendance_history_date AS attdate, attendance_codes.attendance_codes_desc, 
	attendance_history.attendance_history_notes, web_users.web_users_flname, attendance_codes.attendance_codes_id 
	FROM ((((attendance_history INNER JOIN studentbio ON attendance_history.attendance_history_student = studentbio.studentbio_id) 
	INNER JOIN school_years ON attendance_history.attendance_history_year = school_years.school_years_id) 
	INNER JOIN school_names ON attendance_history.attendance_history_school = school_names.school_names_id) 
	INNER JOIN attendance_codes ON attendance_history.attendance_history_code = attendance_codes.attendance_codes_id) 
	INNER JOIN web_users ON attendance_history.attendance_history_user = web_users.web_users_id 
	WHERE attendance_history.attendance_history_id=$attid";
