...
<div id="Content">
	<h1><?php echo _TEACHER_MANAGE_DISCIPLINE_2_TITLE?></h1>
	<br>
	<h2><? echo $discipline->studentbio_fname. " " .$discipline->studentbio_lname; ?></h2>
	<br>
	<h2><?php echo _TEACHER_MANAGE_DISCIPLINE_2_INSERTED?><? echo $discipline->web_users_flname; ?></h2>
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_SCHOOL?></td>
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_YEAR?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_INFRACTION?></td>
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_DATE?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_START_DATE?></td>
	    <td width="50%">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_END_DATE?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_ACTION?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="100%" colspan="2">&nbsp;<? echo $discipline->discipline_history_action ;?></td>
	  </tr>
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_WHO?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="100%" colspan="2">&nbsp;<? echo $discipline->discipline_history_reporter ;?></td>
	  </tr>
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<?php echo _TEACHER_MANAGE_DISCIPLINE_2_NOTES?></td>
	  </tr>
	  <tr class="tblcont">
	...
	<? //display custom fields added by Joshua
     if(count($custom_discipline_fields)) {
		?><tr><td colspan=2><h2><?php echo _TEACHER_MANAGE_DISCIPLINE_2_CUSTOM_FIELDS?></h2></td></tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    <td width="50%"><a href="teacher_edit_student_1.php?studentid=<? echo $studentid; ?>" class="aform"><?php echo _TEACHER_MANAGE_DISCIPLINE_2_BACK?></a></td>
	    <td width="50%" align="right"><a href="teacher_manage_discipline_3.php?studentid=<? echo $studentid; ?>&disid=<? echo $disid; ?>&action=edit" class="aform"><?php echo _TEACHER_MANAGE_DISCIPLINE_3_EDIT?></a></td>
	  </tr>
	</table>
</div>
