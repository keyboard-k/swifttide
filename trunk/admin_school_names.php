...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_SCHOOL_NAMES_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	if ($action!="edit"){
		...
		<form name="addschool" method="post" action="admin_school_names.php">						
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="schoolname" size="20">&nbsp;<A class="aform" href="javascript: submitform('schoolname')"><?php echo _ADMIN_SCHOOL_NAMES_ADD?></a>
	...
	?>
		...
		<form name="editschool" method="post" action="admin_school_names.php">						
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="schoolname" size="20" value="<?php echo $school_names_desc; ?>">&nbsp;<A class="aform" href="javascript: submitform('schoolname')"><?php echo _ADMIN_SCHOOL_NAMES_UPDATE?></a>
