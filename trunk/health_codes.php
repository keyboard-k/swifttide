...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _HEALTH_CODES_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	?>
		...
		<form name="editattendance" method="post" action="health_codes.php">						
	      ...
	      <input type="text" onChange="capitalizeMe(this)" name="healthname" size="20" value="<?php echo $health_codes_desc; 
?>">&nbsp;<A class="aform" href="javascript: submitform('healthname')"><?php echo _HEALTH_CODES_UPDATE?></a>
