...
$msgFormErr="";
if(!$roomid){
	$msgFormErr.=_TEACHER_EXAMS_4_SELECT_ROOM . "<br>";
};
if(!strlen($examdate)){
	$msgFormErr.=_TEACHER_EXAMS_4_FORM_DATE . "<br>";
};
if(!$subjectid){
	$msgFormErr.=_TEACHER_EXAMS_4_FORM_SUBJECT . "<br>";
};
if(!$typeid){
	$msgFormErr.=_TEACHER_EXAMS_4_FORM_TYPE . "<br>";
};
if(!$teacherid){
	$msgFormErr.=_TEACHER_EXAMS_4_FORM_TEACHER . "<br>";
};
...
if(!strlen($msgFormErr)){
	if($action=="update"){
		...
		$msgheader=_TEACHER_EXAMS_4_ADDING;
...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _TEACHER_EXAMS_4_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><? echo _ERROR?> <? echo $msgheader; ?> <? echo _TEACHER_EXAMS_4_TITLE?></h1>
	<br>
	<h2><? echo _TEACHER_EXAMS_4_TITLE?></h2>
	<br>
