...
//from will tell us what form we came from and what form to go back to
$from = get_param("from");
...
switch ($from) {
        case "teach":
		header("Location: admin_teacher_2.php?action=srchschool");
		break;
	case "conta":
		header("Location: admin_contact_2.php?action=searchcontacts");
		break;
}
