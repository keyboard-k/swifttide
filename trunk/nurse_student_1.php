...
function submitform(fldName, frmNumb)
{
  ...
  if (t.value!="") 
	...
	alert("<? echo _NURSE_STUDENT_1_ENTER_VALUE?>");
	return false;
}
...
<div id="Content">
	<h1><? echo _NURSE_STUDENT_1_TITLE?></h1>
	<br>
	<h2><? echo _NURSE_STUDENT_1_SEARCH_DB?></h2>
	<br>
	<table border="0" cellpadding="1" cellspacing="1" width="100%">
	  <tr>
	    <td width="100%" height="45">
	      <table border="1" cellpadding="0" cellspacing="0" width="100%">
	        <tr class="trform">
	          <td width="50%">&nbsp;<? echo _NURSE_STUDENT_1_BY_INTERNAL?></td>
	          <td width="50%">&nbsp;<? echo _NURSE_STUDENT_1_BY_LAST?></td>
		    </tr>
	        <tr>
			   <form name="srchid" method="POST" action="nurse_student_2.php" onsubmit="return submitform('internalid', 0);">
		       <td width="50%" class="tdinput">
	           <input type="text" onChange="capitalizeMe(this)" name="internalid" size="22"><input type="submit" value="<? echo _NURSE_STUDENT_1_SEARCH?>" name="submit" class="frmbut">
		      ...
		      <td width="50%" class="tdinput">
		        <input type="text" onChange="capitalizeMe(this)" name="slname" size="25"><input type="submit" value="<? echo _NURSE_STUDENT_1_SEARCH?>" name="submit" class="frmbut">
	  ...
	  <tr>
	    <td width="100%" height="21">
	      <table border="1" cellpadding="0" cellspacing="0" width="100%">
		    <tr class="trform">
	          <td width="100%" colspan="4">&nbsp;<? echo _NURSE_STUDENT_1_OR_BY?></td>
	        </tr>
		    <tr>
			  <form name="srchall" method="POST" action="nurse_student_2.php">
	          <td width="100%" class="tdinput" colspan="4">
			    <select name="grade">
				   <option value="" selected=selected><? echo _NURSE_STUDENT_1_BY_GRADE?></option>
				   <?
			     ...
			     <select size="1" name="gender">
				    <option value="" selected=selected><? echo _NURSE_STUDENT_1_BY_GENDER?></option>
					<option value="male">Male</option>
					<option value="female">Female</option>
	             </select> 
			     <select size="1" name="ethnicity">
				   <option value="" selected=selected><? echo _NURSE_STUDENT_1_BY_ETHNICITY?></option>
				   <?
		    ...
		    <tr class="trform">
			  ...
			  &nbsp;<? echo _NURSE_STUDENT_1_ACTIVE?>: <input type="radio" value="1" name="active" checked=checked> <? echo _YES?> <input type="radio" value="" name="active"> <? echo _NO?></td>
	          <td width="25%" class="tdinput">
	          &nbsp;<? echo _NURSE_STUDENT_1_HOMED?>: <input type="radio" value="1" name="homed"> <? echo _YES?> <input type="radio" value="" name="homed" checked=checked> <? echo _NO?></td>
			  <td width="25%" class="tdinput">			  
			  &nbsp;<? echo _NURSE_STUDENT_1_SPED?>: <input type="radio" value="1" name="sped"> <? echo _YES?> <input type="radio" value="" name="sped" checked=checked> <? echo _NO?></td>
			  <td width="25%" class="tdinput" align="center">			  
	          <input type="submit" value="<? echo _NURSE_STUDENT_1_SEARCH?>" name="submit" class="frmbut">
	  ...
	  <tr>
	    <td width="100%">
	      <table border="1" cellpadding="0" cellspacing="0" width="100%">
		    <tr class="trform">
	          <td width="100%" colspan="4">&nbsp;<? echo _NURSE_STUDENT_1_SEARCH_LAST?></td>
	        </tr>
			<tr>
