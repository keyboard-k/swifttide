...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _HEALTH_MED_STUDENT_2_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _HEALTH_MED_STUDENT_2_TITLE?></h1>
	<br>
	...
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
	  <tr class="tblhead">
	    ...
	    <td width="50%">&nbsp;<?php echo _HEALTH_MED_STUDENT_2_YEAR?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<?php echo _HEALTH_MED_STUDENT_2_MED?></td>
	    <td width="50%">&nbsp;<?php echo _HEALTH_MED_STUDENT_2_DATE?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="50%">&nbsp;<?php echo $discipline->health_medicine_desc ; ?></td>
		<td width="50%">&nbsp;<?php echo $discipline->disdate ; ?></td>
	  </tr>
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<?php echo _HEALTH_MED_STUDENT_2_REASON?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="100%" colspan="2">&nbsp;<?php echo $discipline->health_med_history_reason ;?></td>
	  </tr>
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<?php echo _HEALTH_MED_STUDENT_2_NOTES?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="100%" colspan="2">&nbsp;<?php echo $discipline->health_med_history_notes ; ?></td>
	  </tr>

	<?// display custom fields added by Joshua
	if(count($custom_discipline_fields)) {
		?><tr><td colspan=2><h2><?php echo _HEALTH_MED_STUDENT_2_CUSTOM_FIELDS?></h2></td></tr>
