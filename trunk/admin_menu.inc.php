...
title="<?php echo _ADMIN_MENU_INC_HEALTH ?>"><?php echo _ADMIN_MENU_INC_HEALTH_TEXT ?></a>
	...
	<TR>
		<TD>
			<a href="admin_manage_discipline_1.php?studentid=<?php echo $studentid;  ?>" title="<?php echo _ADMIN_MENU_INC_DIS ?>"><?php echo _ADMIN_MENU_INC_DIS_TEXT  ?></a>
		</TD>
	</TR>
	<TR>
		<TD>
			<a href="admin_manage_grades_1.php?studentid=<?php echo $studentid;  ?>" title="<?php echo _ADMIN_MENU_INC_GRA ?>"><?php echo _ADMIN_MENU_INC_GRA_TEXT  ?></a>
		</TD>
	</TR>
	<TR>
		<TD>
			<a href="admin_manage_media_1.php?studentid=<?php echo $studentid;  ?>" title="<?php echo _ADMIN_MENU_INC_MEDIA ?>"><?php echo _ADMIN_MENU_INC_MEDIA_TEXT  ?></a>
		</TD>
	</TR>
	<TR>
		<TD>
			<a href="admin_change_student_year.php?studentid=<?php echo $studentid;  ?>" title="<?php echo _ADMIN_MENU_INC_CHANGE  ?>"><?php echo _ADMIN_MENU_INC_CHANGE_TEXT ?></a>
		</TD>
	</TR>
	<TR>
		<td>
