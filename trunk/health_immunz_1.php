...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _HEALTH_IMMUNZ_1_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	?>
	<h1><?php echo _HEALTH_IMMUNZ_1_TITLE?></h1>
	<br>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="70%">
	  <tr>
	    <td width="50%"><a href="health_immunz_1.php?studentid=<?php 
echo $studentid; ?>" class="aform"><?php echo _HEALTH_IMMUNZ_1_BACK?></a></td>
	    <td width="50%" align="right"><a 
href="health_immunz_3.php?studentid=<?php echo $studentid; 
?>&action=new" 
class="aform"><?php echo _HEALTH_IMMUNZ_1_ADD?></a></td>
	  </tr>
	</table>
	<?php
	}else{
