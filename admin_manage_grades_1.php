...
<table width="100%">
  <tr>
    ...
    <td width="50%"><? echo _ADMIN_MANAGE_GRADES_1_UPPER?></td>
  </tr>
</table>
</div>
...
<div id="Content">
	...
	?>
	<h1><? echo _ADMIN_MANAGE_GRADES_1_TITLE?></h1>
	<br>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="80%">
	  <tr>
	    <td width="50%"><a href="admin_edit_student_1.php?studentid=<? echo $studentid; ?>" class="aform"><? echo _ADMIN_MANAGE_GRADES_1_BACK?></a></td>
	    <td width="50%" align="right"><a href="admin_manage_grades_3.php?studentid=<? echo $studentid; ?>&action=new" class="aform"><? echo _ADMIN_MANAGE_GRADES_1_ADD?></a></td>
	  </tr>
	</table>
	<?
	}else{
