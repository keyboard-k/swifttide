...
// Admin Section
// Display media records for student
//*
//Version 1.0 Sept 2007 Doug
...
if(!strlen($studentid)){
	$msgFormErr=_ADMIN_MANAGE_MEDIA_1_FORM_ERROR_2 . "<br>";
}else{
	//Get Student Name
	...
	<td width=20%>" . _ADMIN_MANAGE_MEDIA_1_DATEOUT . "</td>
	<td width=20%>" . _ADMIN_MANAGE_MEDIA_1_DATEDUE . "</td>
	<td width=30%>" . _ADMIN_MANAGE_MEDIA_1_CODE . "</td>
	<td width=15%>" . _ADMIN_MANAGE_MEDIA_1_DETAILS . "</td>
	<td width=15%>" . _ADMIN_MANAGE_MEDIA_1_REMOVE . "</td></tr>"; 
	$ezr->results_close = "</table>";
	$ezr->results_row = "<tr>
	<td align=center class=paging width=20%>COL2</td>
	<td align=center class=paging width=20%>COL3</td>
	<td class=paging width=30% align=center>COL4</td>
	<td class=paging width=15% align=center>
	  <a href=admin_manage_media_2.php?studentid=$studentid&disid=COL1 class=aform>&nbsp;" . _ADMIN_MANAGE_MEDIA_1_DETAILS . "</a>
	</td>
	<td class=paging width=15% align=center>
	  <a href=admin_manage_media_1.php?studentid=$studentid&disid=COL1&action=remove class=aform>&nbsp;" . _ADMIN_MANAGE_MEDIA_1_REMOVE . "</a>
	</td>
	</tr>";
