...
<div id="Content">
	<h1><? echo _CONTACT_MANAGE_ATTENDANCE_2_TITLE?></h1>
	<br>
	<h2><? echo $attendance->studentbio_fname. " " .$attendance->studentbio_lname; ?></h2>
	<br>
	<h2><? echo _CONTACT_MANAGE_ATTENDANCE_2_INSERTED?><? echo $attendance->web_users_flname; ?></h2>
	<table border="1" cellpadding="0" cellspacing="0" width="100%">
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _CONTACT_MANAGE_ATTENDANCE_2_SCHOOL?></td>
	    <td width="50%">&nbsp;<? echo _CONTACT_MANAGE_ATTENDANCE_2_YEAR?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="50%">&nbsp;<? echo _CONTACT_MANAGE_ATTENDANCE_2_CODE?></td>
	    <td width="50%">&nbsp;<? echo _CONTACT_MANAGE_ATTENDANCE_2_DATE?></td>
	  </tr>
	  <tr class="tblcont">
	  ...
	  <tr class="tblhead">
	    <td width="100%" colspan="2">&nbsp;<? echo _CONTACT_MANAGE_ATTENDANCE_2_NOTES?></td>
	  </tr>
	  <tr class="tblcont">
     ...
     if(count($custom_attendance_fields)) {
		?><tr><td colspan=2><h2><? echo _CONTACT_MANAGE_ATTENDANCE_2_CUSTOM_FIELDS?></h2></td></tr>
...
<!--
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
           <tr>
 	    <td width="50%"><a href="contact_manage_attendance_1.php?studentid=<? echo $studentid; ?>" class="aform"><?php echo _CONTACT_MANAGE_ATTENDANCE_2_BACK?></a></td>
 	    <td width="50%" align="right"><a href="contact_manage_attendance_1.php?studentid=<? echo $studentid; ?>&attid=<? echo $attid; ?>&action=edit" class="aform"><?php echo _CONTACT_MANAGE_ATTENDANCE_2_EDIT?></a></td>
           </tr>
        </table>
-->
</div>
