...
<div id="Content">
	...
	<br>
	<h2><?php echo _TEACHER_MANAGE_DISCIPLINE_2_INSERTED?><?php echo $discipline->web_users_flname; ?></h2>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    <td width="50%"><a href="teacher_edit_student_1.php?studentid=<?php echo $studentid; ?>" class="aform"><?php echo _TEACHER_MANAGE_DISCIPLINE_2_BACK?></a></td>
	    <td width="50%" align="right"><a href="teacher_manage_discipline_3.php?studentid=<?php echo $studentid; ?>&disid=<?php echo $disid; ?>&action=edit" class="aform"><?php echo _TEACHER_MANAGE_DISCIPLINE_3_EDIT?></a></td>
	  </tr>
	</table>
</div>
