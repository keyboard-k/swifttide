...
<div id="Content">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="80%">
	  <tr>
	    <td width="50%"><a href="teacher_edit_student_1.php?studentid=<?php echo $studentid; ?>" class="aform"><?php echo _TEACHER_MANAGE_GRADES_1_BACK?></a></td>
	    <td width="50%" align="right"><a href="teacher_manage_grades_3.php?studentid=<?php echo $studentid; ?>&action=new" class="aform"><?php echo _TEACHER_MANAGE_GRADES_1_ADD?></a></td>
	  </tr>
	</table>
	<?php
	}else{
