...
//V1.51 12-29-05 Got rid of error displaying for no reason
//*
...
$msgFormErr="";
if(!$discode){
	$msgFormErr.=_ADMIN_MANAGE_DISCIPLINE_4_ENTER_CODE . "<br>";
};
if(!strlen($disdate)){
	$msgFormErr.=_ADMIN_MANAGE_DISCIPLINE_4_ENTER_DATE . "<br>";
};
if(!strlen($sdate)){
	$msgFormErr.=_ADMIN_MANAGE_DISCIPLINE_4_ENTER_START . "<br>";
};
if(!strlen($edate)){
	$msgFormErr.=_ADMIN_MANAGE_DISCIPLINE_4_ENTER_END . "<br>";
};
if(!strlen($disaction)){
	$msgFormErr.=_ADMIN_MANAGE_DISCIPLINE_4_ENTER_ACTION . "<br>";
};
if(!strlen($disreporter)){
	$msgFormErr.=_ADMIN_MANAGE_DISCIPLINE_4_ENTER_WHO . "<br>";
};
...
//				$mail->AddReplyTo($SMTP_REPLY_TO,$SMTP_FROM_NAME);
				...
				$mail->Subject  = _ADMIN_MANAGE_DISCIPLINE_4_SUBJECT . $sfname." ".$slname; 
				$mail->Body = _ADMIN_MANAGE_DISCIPLINE_4_BODY1 . $sfname." ".$slname . _ADMIN_MANAGE_DISCIPLINE_4_BODY2;
				$mio=$mail->Send();
				if (!$mio)
					echo $mail->ErrorInfo;
			};
		...
		$url="admin_manage_discipline_1.php?studentid=".$studentid;
		header("Location: $url");
		exit();
	};
};
...
<div id="Content">
  <h1><?php echo _ERROR?></h1>
   <br>
   <h2><?php echo _ADMIN_MANAGE_DISCIPLINE_4_ERROR_BACK?></h2>
   <br>
