...
defined( '_VALID' ) or die( 'No direct access allowed.' );

/** common */

DEFINE('_BROWSER_TITLE', 'School Management System');
DEFINE('_WELCOME', 'Welcome');
DEFINE('_YES', 'Yes');
DEFINE('_NO', 'No');
DEFINE('_ENTER_VALUE', 'You have to enter a value!');
DEFINE('_ERROR', 'Error');
DEFINE("_MAX_ATTEMPTS", 4);
DEFINE('_MALE', 'Male');
...
DEFINE('_INDEX_TITLE', 'School Management System' );
DEFINE('_INDEX_ERRLOG', 'UserName / Password incorrect. Please retry.' );
DEFINE('_INDEX_NOTAUTH', 'Not authorized or session expired. Please login.' );
...
DEFINE('_INDEX_PICTURE', 'images/sms_en.gif' );
DEFINE('_INDEX_PICTURE_SMALL', 'images/sms_en_small.gif' );
...
DEFINE('_ADMIN_MAIN_MENU_UPPER', 'Administrator Area' );
DEFINE('_ADMIN_MAIN_MENU_TITLE', 'Admin Main Menu' );
DEFINE('_ADMIN_MAIN_MENU_SUBTITLE', 'Please choose a menu item from your left' );

/** teacher_change_password.php */

DEFINE('_TEACHER_CHANGE_PASSWORD_SUCCESSFUL', 'Password Successfully Changed.' );
DEFINE('_TEACHER_CHANGE_PASSWORD_TITLE', 'Change your access password' );
DEFINE('_TEACHER_CHANGE_PASSWORD_UPDATE', 'Update Password' );

/** teacher_change_student_year.php */

DEFINE('_TEACHER_CHANGE_STUDENT_YEAR_CONFIRM', 'The default year for students wil be changed. Continue?' );
DEFINE('_TEACHER_CHANGE_STUDENT_YEAR_TITLE', 'Change Default Year for Students' );
DEFINE('_TEACHER_CHANGE_STUDENT_YEAR_SELECT', 'Select available years:' );

/** teacher_edit_student_1.php */

DEFINE('_TEACHER_EDIT_STUDENT_1_TITLE', 'Manage Student' );
DEFINE('_TEACHER_EDIT_STUDENT_1_INTERNAL_ID', 'Internal ID' );
DEFINE('_TEACHER_EDIT_STUDENT_1_ETHNICITY', 'Ethnicity' );
DEFINE('_TEACHER_EDIT_STUDENT_1_BIRTHDATE', 'Date of Birth' );
DEFINE('_TEACHER_EDIT_STUDENT_1_SCHOOL', 'School' );
DEFINE('_TEACHER_EDIT_STUDENT_1_GRADE', 'Grade' );
DEFINE('_TEACHER_EDIT_STUDENT_1_ACTIVE', 'Active' );
DEFINE('_TEACHER_EDIT_STUDENT_1_HOMED', 'Homed' );
DEFINE('_TEACHER_EDIT_STUDENT_1_SPED', 'Sped' );
DEFINE('_TEACHER_EDIT_STUDENT_1_ENTRY_RECORD', 'Entry Record' );
DEFINE('_TEACHER_EDIT_STUDENT_1_NOTES', 'Notes');
DEFINE('_TEACHER_EDIT_STUDENT_1_BIRTHCITY', 'Birth City');
DEFINE('_TEACHER_EDIT_STUDENT_1_BIRTHSTATE', 'Birth State');
DEFINE('_TEACHER_EDIT_STUDENT_1_BIRTHCOUNTRY', 'Birth Country');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRVS_SCHOOLNAME', 'Prvs School Name');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRVS_SCHOOLADDRESS', 'Prvs School Address');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRVS_SCHOOLCITY', 'Prvs School City');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRVS_SCHOOLSTATE', 'Prvs School State');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRVS_SCHOOLZIP', 'Prvs School Zip');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRVS_SCHOOLCOUNTRY', 'Prvs School Country');
DEFINE('_TEACHER_EDIT_STUDENT_1_CUSTOM_FIELDS', 'Custom Fields');
DEFINE('_TEACHER_EDIT_STUDENT_1_PRIMARY_CONTACT', 'Primary Contact');
DEFINE('_TEACHER_EDIT_STUDENT_1_RESIDENCE', 'Residence');
DEFINE('_TEACHER_EDIT_STUDENT_1_ADDRESS', 'Address');
DEFINE('_TEACHER_EDIT_STUDENT_1_CITY', 'City');
DEFINE('_TEACHER_EDIT_STUDENT_1_STATE', 'State');
DEFINE('_TEACHER_EDIT_STUDENT_1_ZIP', 'Zip');
DEFINE('_TEACHER_EDIT_STUDENT_1_PHONE1', 'Phone #');
DEFINE('_TEACHER_EDIT_STUDENT_1_PHONE2', 'Alt. Phone #');
DEFINE('_TEACHER_EDIT_STUDENT_1_PHONE3', 'Alt. Phone #');
DEFINE('_TEACHER_EDIT_STUDENT_1_EMAIL', 'Email');
DEFINE('_TEACHER_EDIT_STUDENT_1_WEB_USER', 'Web User');
DEFINE('_TEACHER_EDIT_STUDENT_1_ADD_CONTACTS', 'Additional Contacts');
DEFINE('_TEACHER_EDIT_STUDENT_1_ADD_FIRST_NAME', 'First Name');
DEFINE('_TEACHER_EDIT_STUDENT_1_ADD_LAST_NAME', 'Last Name');
DEFINE('_TEACHER_EDIT_STUDENT_1_ADD_RELATION', 'Relation');
...
DEFINE('_TEACHER_EDIT_STUDENT_2_TITLE', 'Manage Students' );
DEFINE('_TEACHER_EDIT_STUDENT_2_CONTACT', 'Contact' );
DEFINE('_TEACHER_EDIT_STUDENT_2_RESIDENCE', 'Residence' );
DEFINE('_TEACHER_EDIT_STUDENT_2_ADDRESS', 'Address');
DEFINE('_TEACHER_EDIT_STUDENT_2_CITY', 'City');
DEFINE('_TEACHER_EDIT_STUDENT_2_STATE', 'State');
DEFINE('_TEACHER_EDIT_STUDENT_2_ZIP', 'Zip');
DEFINE('_TEACHER_EDIT_STUDENT_2_PHONE1', 'Phone #');
DEFINE('_TEACHER_EDIT_STUDENT_2_PHONE2', 'Alt. Phone #');
DEFINE('_TEACHER_EDIT_STUDENT_2_PHONE3', 'Alt. Phone #');
DEFINE('_TEACHER_EDIT_STUDENT_2_EMAIL', 'Email');
DEFINE('_TEACHER_EDIT_STUDENT_2_WEB_USER', 'Web User');
DEFINE('_TEACHER_EDIT_STUDENT_2_BACK', 'Back to Student');

/** teacher_homework.php */

DEFINE('_TEACHER_HOMEWORK_ENTER_NAME', 'You must enter a name for your new assignement');
DEFINE('_TEACHER_HOMEWORK_ENTER_SUBJECT', 'You must enter a subject for your new assignement');
DEFINE('_TEACHER_HOMEWORK_ENTER_DATE', 'You must enter the date you made this new assignment');
DEFINE('_TEACHER_HOMEWORK_ENTER_DATE_DUE', 'You must enter a due date for your new assignement');
DEFINE('_TEACHER_HOMEWORK_DELETE_ASSIGNMENT', 'Are you sure you wish to delete this assignment?');
DEFINE('_TEACHER_HOMEWORK_TITLE', 'Homework');
DEFINE('_TEACHER_HOMEWORK_NEW_HOMEWORK', 'New Homework');
DEFINE('_TEACHER_HOMEWORK_HOMEWORK_NAME', 'Name');
DEFINE('_TEACHER_HOMEWORK_ASSIGNED_ON', 'Assigned on');
DEFINE('_TEACHER_HOMEWORK_DUE_ON', 'Due on');
DEFINE('_TEACHER_HOMEWORK_NOTES', 'Notes');
DEFINE('_TEACHER_HOMEWORK_SUBJECT', 'Notes');
DEFINE('_TEACHER_HOMEWORK_DELETE_BUTTON', 'Delete assignment');
DEFINE('_TEACHER_HOMEWORK_UPDATE_BUTTON', 'Update assignment');

/** teacher_manage_attendance_1.php */

DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_FORM_ERROR', 'You should select a student first.');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_DATE', 'Date');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_CODE', 'Code');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_DETAILS', 'Details');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_TITLE', 'Attendance history for student');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_1_ADD_NOTE', 'Add Attendance Note');

/** teacher_manage_attendance_2.php */

DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_TITLE', 'Attendance history for student');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_SCHOOL', 'School');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_YEAR', 'Year');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_CODE', 'Code');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_DATE', 'Date');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_NOTES', 'Notes');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_2_EDIT', 'Edit Attendance Note');

/** teacher_manage_attendance_3.php */

DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_TITLE', 'Attendance history for student');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_INSERTED', 'Note inserted by ');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_SCHOOL', 'School');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_YEAR', 'Year');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_CODE', 'Code');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_DATE', 'Date');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_SELECT_CODE', 'Select Code');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_NOTES', 'Notes');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_NOTIFY', 'Notify Contacts');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_CUSTOM_FIELDS', 'Custom Fields');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_DELETE', 'Delete');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_ADD', 'Add Note');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_NEW', 'Add New');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_EDIT', 'Edit Note');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_3_UPDATE', 'Update Note');

/** teacher_manage_attendance_4.php */

DEFINE('_TEACHER_MANAGE_ATTENDANCE_4_SUBJECT', 'New attendance note for ');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_4_BODY1', 'A new attendance note has been inserted for ');
DEFINE('_TEACHER_MANAGE_ATTENDANCE_4_BODY2', 'Please login to the parents interface website for details. Thanks - The Principal');

/** teacher_manage_discipline_1.php */

DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_FORM_ERROR', 'You should select a student first.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_DATE', 'Date');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_CODE', 'Code');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_DETAILS', 'Details');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_TITLE', 'Discipline history for student');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_ADD_NOTE', 'Add Discipline Note');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_1_BACK', 'Back to Student');

/** teacher_manage_attendance_2.php */

DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_TITLE', 'Discipline history for student');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_SCHOOL', 'School');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_YEAR', 'Year');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_INFRACTION', 'Infraction');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_DATE', 'Date');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_START_DATE', 'Anfang');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_END_DATE', 'Ende');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_NOTES', 'Notes');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_EDIT', 'Edit Discipline Note');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_INSERTED', 'Note inserted by ');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_ACTION', 'Action to be Taken');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_WHO', 'Who reported the infraction');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_2_CUSTOM_FIELDS', 'Custom Fields');

/** teacher_manage_attendance_3.php */

DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_TITLE', 'Attendance history for student');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_INSERTED', 'Note inserted by ');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_SCHOOL', 'School');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_YEAR', 'Year');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_INFRACTION', 'Infraction');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_DATE', 'Date');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_START_DATE', 'Start Date');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_END_DATE', 'End Date');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_SELECT_CODE', 'Select Code');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_NOTES', 'Notes');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_NOTIFY', 'Notify Contacts');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_CUSTOM_FIELDS', 'Custom Fields');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_DELETE', 'Delete');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_NEW', 'Add New');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_ADD', 'Add Note');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_EDIT', 'Edit Note');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_UPDATE', 'Update Note');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_SELECT', 'Select Infraction');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_ACTION', 'Action to be Taken');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_3_WHO', 'Who reported the infraction');

/** teacher_manage_attendance_4.php */

DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ENTER_CODE', 'You have to select an infraction code.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ENTER_DATE', 'You have to select a date of infraction.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ENTER_START', 'You have to select a starting date.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ENTER_END', 'You have to select an ending date.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ENTER_ACTION', 'You have to assign the action to be taken.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ENTER_WHO', 'You have to assign who reported the infraction.');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_SUBJECT', 'New discipline note for ');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_BODY1', 'A new discipline note has been inserted for ');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_BODY2', 'Please login to the parents interface website for details. Thanks - The Principal');
DEFINE('_TEACHER_MANAGE_DISCIPLINE_4_ERROR_BACK', 'Please use your browser \'back\' button to correct the following error(s):');

/** teacher_manage_grades_1.php */

DEFINE('_TEACHER_MANAGE_GRADES_1_FORM_ERROR', 'You should select a student first.');
DEFINE('_TEACHER_MANAGE_GRADES_1_QUARTER', 'Qrtr');
DEFINE('_TEACHER_MANAGE_GRADES_1_GRADE', 'Grade');
DEFINE('_TEACHER_MANAGE_GRADES_1_EFFORT', 'Effort');
DEFINE('_TEACHER_MANAGE_GRADES_1_CONDUCT', 'Conduct');
DEFINE('_TEACHER_MANAGE_GRADES_1_SUBJECT', 'Subject');
DEFINE('_TEACHER_MANAGE_GRADES_1_DETAILS', 'Details');
DEFINE('_TEACHER_MANAGE_GRADES_1_TITLE', 'Grade history for student');
DEFINE('_TEACHER_MANAGE_GRADES_1_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_GRADES_1_ADD', 'Add Grade Note');

/** teacher_manage_grades_2.php */

DEFINE('_TEACHER_MANAGE_GRADES_2_TITLE', 'Grade history for student');
DEFINE('_TEACHER_MANAGE_GRADES_2_INSERTED', 'Note inserted by ');
DEFINE('_TEACHER_MANAGE_GRADES_2_FOR', 'for');
DEFINE('_TEACHER_MANAGE_GRADES_2_SCHOOL', 'School');
DEFINE('_TEACHER_MANAGE_GRADES_2_YEAR', 'Year');
DEFINE('_TEACHER_MANAGE_GRADES_2_TERM', 'Term');
DEFINE('_TEACHER_MANAGE_GRADES_2_GRADE', 'Grade');
DEFINE('_TEACHER_MANAGE_GRADES_2_EFFORT', 'Effort');
DEFINE('_TEACHER_MANAGE_GRADES_2_CONDUCT', 'Conduct');
DEFINE('_TEACHER_MANAGE_GRADES_2_DETAILS', 'Details');
DEFINE('_TEACHER_MANAGE_GRADES_2_COMMENTS', 'Comments');
DEFINE('_TEACHER_MANAGE_GRADES_2_NOTES', 'Notes');
DEFINE('_TEACHER_MANAGE_GRADES_2_CUSTOM_FIELDS', 'Custom Fields');
DEFINE('_TEACHER_MANAGE_GRADES_2_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_GRADES_2_EDIT', 'Edit Grade Note');

/** teacher_manage_grades_3.php */

DEFINE('_TEACHER_MANAGE_GRADES_3_TITLE', 'Grade history for student');
DEFINE('_TEACHER_MANAGE_GRADES_3_INSERTED', 'Note inserted by ');
DEFINE('_TEACHER_MANAGE_GRADES_3_YEAR', 'Year');
DEFINE('_TEACHER_MANAGE_GRADES_3_SUBJECT', 'Subject');
DEFINE('_TEACHER_MANAGE_GRADES_3_TERM', 'Term');
DEFINE('_TEACHER_MANAGE_GRADES_3_OVERALL', 'Overall Grade');
DEFINE('_TEACHER_MANAGE_GRADES_3_EFFORT', 'Effort');
DEFINE('_TEACHER_MANAGE_GRADES_3_CONDUCT', 'Conduct');
DEFINE('_TEACHER_MANAGE_GRADES_3_COMMENTS', 'Comments');
DEFINE('_TEACHER_MANAGE_GRADES_3_NOTES', 'Notes');
DEFINE('_TEACHER_MANAGE_GRADES_3_NOTIFY', 'Notify Contacts');
DEFINE('_TEACHER_MANAGE_GRADES_3_CUSTOM_FIELDS', 'Custom Fields');
DEFINE('_TEACHER_MANAGE_GRADES_3_DELETE', 'Delete');
DEFINE('_TEACHER_MANAGE_GRADES_3_NEW', 'Add New');
DEFINE('_TEACHER_MANAGE_GRADES_3_BACK', 'Back to Student');
DEFINE('_TEACHER_MANAGE_GRADES_3_UPDATE', 'Update Note');
DEFINE('_TEACHER_MANAGE_GRADES_3_ADD', 'Add Note');

/** teacher_manage_grades_4.php */

DEFINE('_TEACHER_MANAGE_GRADES_4_ENTER_TERM', 'You have to select a grading term name');
DEFINE('_TEACHER_MANAGE_GRADES_4_ENTER_GRADE', 'You have to select a grade.');
DEFINE('_TEACHER_MANAGE_GRADES_4_ENTER_EFFORT', 'You have to select an effort grade.');
DEFINE('_TEACHER_MANAGE_GRADES_4_ENTER_CONDUCT', 'You have to select an conduct grade.');
DEFINE('_TEACHER_MANAGE_GRADES_4_SUBJECT', 'New grade note for ');
DEFINE('_TEACHER_MANAGE_GRADES_4_BODY1', 'A new grade note has been inserted for ');
DEFINE('_TEACHER_MANAGE_GRADES_4_BODY2', 'Please login to the parents interface website for details. Thanks - The Principal');
DEFINE('_TEACHER_MANAGE_GRADES_4_ERROR_BACK', 'Please use your browser \'back\' button to correct the following error(s):');
DEFINE('_TEACHER_MANAGE_GRADES_4_GRADE_NOTE', 'Grade Note');

/** teacher_menu_forum.inc.php */

DEFINE('_TEACHER_MENU_FORUM_INC_PHP_MAIN', 'Back to Main Menu');
DEFINE('_TEACHER_MENU_FORUM_INC_PHP_MAIN_TEXT', 'Main Menu');

/** teacher_menu.inc.php */

DEFINE('_TEACHER_MENU_INC_PHP_MAIN', 'Back to Main Menu');
DEFINE('_TEACHER_MENU_INC_PHP_MAIN_TEXT', 'Main Menu');
DEFINE('_TEACHER_MENU_INC_PHP_TIMETABLE', 'Timetable');
DEFINE('_TEACHER_MENU_INC_PHP_TIMETABLE_TEXT', 'Timetable');
DEFINE('_TEACHER_MENU_INC_PHP_EXAMS', 'Manage Exams');
DEFINE('_TEACHER_MENU_INC_PHP_EXAMS_TEXT', 'Exams and Tests');
DEFINE('_TEACHER_MENU_INC_PHP_STUDENTS', 'Manage Students');
DEFINE('_TEACHER_MENU_INC_PHP_STUDENTS_TEXT', 'Manage Students');
DEFINE('_TEACHER_MENU_INC_PHP_ATTENDANCE', 'Manage Attendance');
DEFINE('_TEACHER_MENU_INC_PHP_ATTENDANCE_TEXT', 'Attendance');
DEFINE('_TEACHER_MENU_INC_PHP_DISCIPLINE', 'Manage Discipline');
DEFINE('_TEACHER_MENU_INC_PHP_DISCIPLINE_TEXT', 'Discipline');
DEFINE('_TEACHER_MENU_INC_PHP_SINGLE', 'Single Grade Entering');
DEFINE('_TEACHER_MENU_INC_PHP_SINGLE_TEXT', 'One Student Grade');
DEFINE('_TEACHER_MENU_INC_PHP_BULK', 'Bulk Grade Entering');
DEFINE('_TEACHER_MENU_INC_PHP_BULK_TEXT', 'Bulk Grades');
DEFINE('_TEACHER_MENU_INC_PHP_YEAR', 'Change Student Year');
DEFINE('_TEACHER_MENU_INC_PHP_YEAR_TEXT', 'Change Student Year');
DEFINE('_TEACHER_MENU_INC_PHP_HOMEWORK', 'Homework');
...
DEFINE('_TEACHER_MENU_INC_PHP_CHANGE_TEXT', 'Change Password');
DEFINE('_TEACHER_MENU_INC_PHP_LOGOUT_TEXT', 'Logout');
DEFINE('_TEACHER_MENU_INC_PHP_LOGOUT', 'Logout from System');
DEFINE('_TEACHER_MENU_INC_PHP_CURRENT_YEAR', 'Year');

/** teachers_menu.inc.php */

DEFINE('_TEACHERS_MENU_TITLE', 'Teachers\' Main Menu');
DEFINE('_TEACHERS_MENU_CHOOSE', 'Please choose a menu item from your left');
DEFINE('_TEACHERS_MENU_BIRTHDAY', 'Birthday today:');
DEFINE('_TEACHERS_MENU_LASTNAME', 'Last Name');
DEFINE('_TEACHERS_MENU_FIRSTNAME', 'First Name');
DEFINE('_TEACHERS_MENU_HOMEROOM', 'Homeroom');
DEFINE('_TEACHERS_MENU_GENDER', 'Gender');
DEFINE('_TEACHERS_MENU_DOB', 'Date of Birth');
DEFINE('_TEACHERS_MENU_AGE', 'Age');

/** teacher_schedule_1.php */

DEFINE('_TEACHER_SCHEDULE_1_ERROR_FORM', 'You should select a student first.');
DEFINE('_TEACHER_SCHEDULE_1_DATE', 'Date');
DEFINE('_TEACHER_SCHEDULE_1_CODE', 'Code');
DEFINE('_TEACHER_SCHEDULE_1_DETAILS', 'Details');
DEFINE('_TEACHER_SCHEDULE_1_ADMIN_AREA', 'Administrator Area');
DEFINE('_TEACHER_SCHEDULE_1_TITLE', 'Teacher Schedule for');
DEFINE('_TEACHER_SCHEDULE_1_BACK', 'Back to Teacher');
DEFINE('_TEACHER_SCHEDULE_1_ADD', 'Add Schedule Eintry');

/** teacher_schedule_2.php */

DEFINE('_TEACHER_SCHEDULE_2_ADMIN_AREA', 'Administrator Area');
DEFINE('_TEACHER_SCHEDULE_2_TITLE', 'Teacher Schedule for');
DEFINE('_TEACHER_SCHEDULE_2_INSERTED', 'Note inserted by ');
DEFINE('_TEACHER_SCHEDULE_2_SCHOOL', 'School');
DEFINE('_TEACHER_SCHEDULE_2_YEAR', 'Year');
DEFINE('_TEACHER_SCHEDULE_2_CODE', 'Code');
DEFINE('_TEACHER_SCHEDULE_2_DATE', 'Date');
DEFINE('_TEACHER_SCHEDULE_2_NOTES', 'Notes');
DEFINE('_TEACHER_SCHEDULE_2_BACK', 'Back to Student');
DEFINE('_TEACHER_SCHEDULE_2_EDIT', 'Edit Attendance Note');

/** teacher_schedule_3.php */

DEFINE('_TEACHER_SCHEDULE_3_ADMIN_AREA', 'Administrator Area');
DEFINE('_TEACHER_SCHEDULE_3_TITLE', 'Teacher Schedule for');
DEFINE('_TEACHER_SCHEDULE_3_TERM', 'Term');
DEFINE('_TEACHER_SCHEDULE_3_CLASS_PERIOD', 'Class Period');
DEFINE('_TEACHER_SCHEDULE_3_CODE', 'Nummer');
DEFINE('_TEACHER_SCHEDULE_3_SUBJECT', 'Subject');
DEFINE('_TEACHER_SCHEDULE_3_SELECT', 'Select Code');
DEFINE('_TEACHER_SCHEDULE_3_NOTES', 'Notes');
DEFINE('_TEACHER_SCHEDULE_3_BACK', 'Back to Teacher');
DEFINE('_TEACHER_SCHEDULE_3_UPDATE', 'Update Note');
DEFINE('_TEACHER_SCHEDULE_3_ADD', 'Add Note');

/** teachers_homework.php */

DEFINE('_TEACHERS_HOMEWORK_ENTER_NEW_NAME', 'You must enter a name for your new assignment');
DEFINE('_TEACHERS_HOMEWORK_ENTER_NEW_SUBJECT', 'You must enter a subject for your new assignment');
DEFINE('_TEACHERS_HOMEWORK_ENTER_NEW_DATE', 'You must enter the date you made this new assignment');
DEFINE('_TEACHERS_HOMEWORK_ENTER_NEW_DUE_DATE', 'You must enter a due date for your new assignement');
DEFINE('_TEACHERS_HOMEWORK_ENTER_SUBJECT', 'You must enter a subject for your new assignment');
DEFINE('_TEACHERS_HOMEWORK_ENTER_DATE', 'You must enter the date you made this new assignment');
DEFINE('_TEACHERS_HOMEWORK_ENTER_DUE_DATE', 'You must enter a due date for your new assignement');
DEFINE('_TEACHERS_HOMEWORK_DELETE', 'Are you sure you wish to delete this assignment?');
DEFINE('_TEACHERS_HOMEWORK_FILE_TITLE', 'You must enter a title for your new homework file');
DEFINE('_TEACHERS_HOMEWORK_FILE_INVALID', 'Invalid filename');
DEFINE('_TEACHERS_HOMEWORK_DELETE_FILE', 'Are you certain you wish to delete this file?');
DEFINE('_TEACHERS_HOMEWORK_TITLE', 'Homework');
DEFINE('_TEACHERS_HOMEWORK_NEW_TITLE', 'New Homework');
DEFINE('_TEACHERS_HOMEWORK_NEW_NAME', 'Name');
DEFINE('_TEACHERS_HOMEWORK_NEW_SUBJECT', 'Subject');
DEFINE('_TEACHERS_HOMEWORK_NEW_ROOM', 'Room');
DEFINE('_TEACHERS_HOMEWORK_ASSIGNED_ON', 'Assigned on');
DEFINE('_TEACHERS_HOMEWORK_DUE_ON', 'Due on');
DEFINE('_TEACHERS_HOMEWORK_NOTES', 'Notes');
DEFINE('_TEACHERS_HOMEWORK_ADD', 'Add Assignment');
DEFINE('_TEACHERS_HOMEWORK_SUBJECT', 'Subject');
DEFINE('_TEACHERS_HOMEWORK_ROOM', 'Room');
DEFINE('_TEACHERS_HOMEWORK_DEL_ASSIGNMENT', 'Delete Assignment');
DEFINE('_TEACHERS_HOMEWORK_UPD_ASSIGNMENT', 'Update Assignment');
DEFINE('_TEACHERS_HOMEWORK_TITLE2', 'Assignment Files');
DEFINE('_TEACHERS_HOMEWORK_FILES_TITLE', 'Title');
DEFINE('_TEACHERS_HOMEWORK_FILES_LOCATION', 'Location');
DEFINE('_TEACHERS_HOMEWORK_FILES_ADD', 'Add');
DEFINE('_TEACHERS_HOMEWORK_FILES_DELETE', 'Delete');

/** teacher_student_1.php */

DEFINE('_TEACHER_STUDENT_1_TITLE', 'Manage Students');
DEFINE('_TEACHER_STUDENT_1_SEARCH_DB', 'Search the database');
DEFINE('_TEACHER_STUDENT_1_BY_ID', 'By Internal ID');
DEFINE('_TEACHER_STUDENT_1_BY_NAME', 'By Name');
DEFINE('_TEACHER_STUDENT_1_SEARCH', 'Search');
DEFINE('_TEACHER_STUDENT_1_BY_OTHER', 'Or By');
DEFINE('_TEACHER_STUDENT_1_BY_GRADE', 'By Grade');
DEFINE('_TEACHER_STUDENT_1_BY_GENDER', 'By Gender');
DEFINE('_TEACHER_STUDENT_1_BY_ETHNICITY', 'By Ethnicity');
DEFINE('_TEACHER_STUDENT_1_ACTIVE', 'Active');
DEFINE('_TEACHER_STUDENT_1_HOMED', 'Homed');
DEFINE('_TEACHER_STUDENT_1_SPED', 'Sp.Ed.');
DEFINE('_TEACHER_STUDENT_1_BY_LAST', 'Or display by last name initial');

/** teacher_student_2.php */

DEFINE('_TEACHER_STUDENT_2_ERROR_ID', 'No Student found with Internal ID ');
DEFINE('_TEACHER_STUDENT_2_ERROR_LAST', 'No Student found with Last Name ');
DEFINE('_TEACHER_STUDENT_2_SELECT', 'Select');
DEFINE('_TEACHER_STUDENT_2_ERROR_CRITERIA', 'No Student found with your search criteria.');
DEFINE('_TEACHER_STUDENT_2_TITLE', 'Student Search Result');
DEFINE('_TEACHER_STUDENT_2_NEW', 'New Search');

/** teacher_timetable.php */

DEFINE('_TEACHER_TIMETABLE_UPPER', 'Teacher Area');
DEFINE('_TEACHER_TIMETABLE_TITLE', 'Timetable');
DEFINE('_TEACHER_TIMETABLE_SCHOOL', 'School');
DEFINE('_TEACHER_TIMETABLE_TERM', 'Term');
DEFINE('_TEACHER_TIMETABLE_SUBJECT', 'Subject');
DEFINE('_TEACHER_TIMETABLE_DAYS', 'Day(s)');
DEFINE('_TEACHER_TIMETABLE_PERIOD', 'Period');
DEFINE('_TEACHER_TIMETABLE_ROOM', 'Room');

/** grade_student_1.php */

DEFINE('_GRADE_STUDENT_1_UPPER', 'Grade Report Area');
DEFINE('_GRADE_STUDENT_1_TITLE', 'Enter Student Grades');
DEFINE('_GRADE_STUDENT_1_TITLE2', 'Build the Student List');
DEFINE('_GRADE_STUDENT_1_CHOOSE', 'Choose School, Subject, Term and Grade');
DEFINE('_GRADE_STUDENT_1_CHOOSE_SCHOOL', 'Choose School');
DEFINE('_GRADE_STUDENT_1_CHOOSE_GRADE', 'Choose Grade');
DEFINE('_GRADE_STUDENT_1_CHOOSE_TERM', 'Choose Term');
DEFINE('_GRADE_STUDENT_1_CHOOSE_SUBJECT', 'Choose Subject');
DEFINE('_GRADE_STUDENT_1_BUILD', 'Build List');

/** grade_student_2.php */

DEFINE('_GRADE_STUDENT_2_ENTER_TERM', 'You need to specify the grading term.');
DEFINE('_GRADE_STUDENT_2_ENTER_SUBJECT', 'You need to specify the subject you are grading for!');
DEFINE('_GRADE_STUDENT_2_TEACHER_AREA', 'Teacher Area');
DEFINE('_GRADE_STUDENT_2_SELECT', 'Select');
DEFINE('_GRADE_STUDENT_2_FORM_ERROR', 'No Student found with your search criteria.');
DEFINE('_GRADE_STUDENT_2_TITLE', 'Student Search Result for Bulk Grades');
DEFINE('_GRADE_STUDENT_2_NEW', 'New Search');

/** grade_student_3.php */

DEFINE('_GRADE_STUDENT_3_TITLE', 'Grade history for student');
DEFINE('_GRADE_STUDENT_3_TITLE2', 'Grade for Term ');
DEFINE('_GRADE_STUDENT_3_SCHOOL', 'School');
DEFINE('_GRADE_STUDENT_3_YEAR', 'Year');
DEFINE('_GRADE_STUDENT_3_SUBJECT', 'Subject');
DEFINE('_GRADE_STUDENT_3_OVERALL', 'Overall Grade');
DEFINE('_GRADE_STUDENT_3_EFFORT', 'Effort');
DEFINE('_GRADE_STUDENT_3_CONDUCT', 'Conduct');
DEFINE('_GRADE_STUDENT_3_COMMENTS', 'Comments');
DEFINE('_GRADE_STUDENT_3_NOTES', 'Notes');
DEFINE('_GRADE_STUDENT_3_NOTIFY', 'Notify Contacts');
DEFINE('_GRADE_STUDENT_3_BACK', 'Back to Student');
DEFINE('_GRADE_STUDENT_3_UPDATE', 'Update Note');
DEFINE('_GRADE_STUDENT_3_ADD', 'Add Note');

/** grade_student_4.php */

DEFINE('_GRADE_STUDENT_4_ENTER_QUARTER', 'You have to select a quarter.');
DEFINE('_GRADE_STUDENT_4_ENTER_OVERALL', 'You have to enter an overall grade.');
DEFINE('_GRADE_STUDENT_4_ENTER_EFFORT', 'You have to select an effort grade.');
DEFINE('_GRADE_STUDENT_4_ENTER_CONDUCT', 'You have to select a conduct grade.');
DEFINE('_GRADE_STUDENT_4_FORMERROR', 'Failed.  Close Window, Note Errors below, and try again.');
DEFINE('_GRADE_STUDENT_4_SUBJECT', 'New grade note for ');
DEFINE('_GRADE_STUDENT_4_BODY1', 'A new grade note has been inserted for ');
DEFINE('_GRADE_STUDENT_4_BODY2', 'Please login to the parents interface website for details. Thanks - The Principal');
DEFINE('_GRADE_STUDENT_4_TITLE', 'Grade Note');
DEFINE('_GRADE_STUDENT_4_CONTINUE', 'Click Here to Continue With Other Students');
...
DEFINE('_SCHEDULE_TEACHER_1_ENTER_VALUE', 'You have to enter a value!');
DEFINE('_SCHEDULE_TEACHER_1_ADMIN_AREA', 'Administrator Area');
DEFINE('_SCHEDULE_TEACHER_1_TITLE', 'Set Up Teacher Scheduling');
DEFINE('_SCHEDULE_TEACHER_1_TITLE2', 'Select a Teacher');
DEFINE('_SCHEDULE_TEACHER_1_BY_SCHOOL', 'By School');
DEFINE('_SCHEDULE_TEACHER_1_BY_LAST', 'By Last Name');
DEFINE('_SCHEDULE_TEACHER_1_ALL', 'All Schools');
DEFINE('_SCHEDULE_TEACHER_1_SEARCH', 'Search');
DEFINE('_SCHEDULE_TEACHER_1_SEARCH_LAST', 'Or display by last name initial');

/** schedule_teacher_2.php */

DEFINE('_SCHEDULE_TEACHER_2_REMOVE', 'Remove');
DEFINE('_SCHEDULE_TEACHER_2_NO_TEACHERS', 'No Teachers found for school ');
DEFINE('_SCHEDULE_TEACHER_2_NO_FOUND', 'No Teachers found.');
DEFINE('_SCHEDULE_TEACHER_2_SELECT', 'Select');
DEFINE('_SCHEDULE_TEACHER_2_ADMIN_AREA', 'Administrator Area');
DEFINE('_SCHEDULE_TEACHER_2_TITLE', 'Teacher Search Result');
DEFINE('_SCHEDULE_TEACHER_2_NEW', 'New Search');

/** schedule_teacher_3.php */

DEFINE('_SCHEDULE_TEACHER_3_ENTER_VALUE', 'You have to enter a value!');
DEFINE('_SCHEDULE_TEACHER_3_ADMIN_AREA', 'Administrator Area');
DEFINE('_SCHEDULE_TEACHER_3_TITLE', 'Title');
DEFINE('_SCHEDULE_TEACHER_3_FIRST', 'First Name');
DEFINE('_SCHEDULE_TEACHER_3_LAST', 'Last Name');
DEFINE('_SCHEDULE_TEACHER_3_MI', 'MI');
DEFINE('_SCHEDULE_TEACHER_3_SUBJECTS', 'Subjects');
DEFINE('_SCHEDULE_TEACHER_3_EMAIL', 'Email');
DEFINE('_SCHEDULE_TEACHER_3_ACCESS', 'Access to Health');
DEFINE('_SCHEDULE_TEACHER_3_USERNAME', 'Username');
DEFINE('_SCHEDULE_TEACHER_3_PASSWORD', 'Password');

/** report_attendance.php */

DEFINE('_REPORT_ATTENDANCE_BROWSER_TITLE', 'Student Report');
DEFINE('_REPORT_ATTENDANCE_TITLE', 'Attendance Record for ');
DEFINE('_REPORT_ATTENDANCE_ROUTE', 'Bus Route ');
DEFINE('_REPORT_ATTENDANCE_HOME', 'Home Room ');
DEFINE('_REPORT_ATTENDANCE_NOTES', 'Notes');
DEFINE('_REPORT_ATTENDANCE_SCHOOL', 'School');
DEFINE('_REPORT_ATTENDANCE_INTERNAL', 'Internal ID');
DEFINE('_REPORT_ATTENDANCE_DOB', 'DOB');
DEFINE('_REPORT_ATTENDANCE_NONE', 'No matching records to display');
DEFINE('_REPORT_ATTENDANCE_GRADE', 'Grade');
DEFINE('_REPORT_ATTENDANCE_ETHNICITY', 'Ethnicity');

/** report_discipline.php */

DEFINE('_REPORT_DISCIPLINE_BROWSER_TITLE', 'Student Report');
DEFINE('_REPORT_DISCIPLINE_HEADER', 'Discipline Report');
DEFINE('_REPORT_DISCIPLINE_FROM', ' from ');
DEFINE('_REPORT_DISCIPLINE_TO', 'to ');
...
DEFINE('_REPORT_DISCIPLINE_ACTION', 'Action');
DEFINE('_REPORT_DISCIPLINE_DOB', 'DOB');
DEFINE('_REPORT_DISCIPLINE_NONE', 'No matching records to display');
DEFINE('_REPORT_DISCIPLINE_GRADE', 'Grade');
DEFINE('_REPORT_DISCIPLINE_ETHNICITY', 'Ethnicity');

/** report_grades.php */

DEFINE('_REPORT_GRADES_VALUE', ' is the value');
DEFINE('_REPORT_GRADES_VALUE2', 'your string is ');
DEFINE('_REPORT_GRADES_NONE', 'No matching records to display');
...
// DEFINE("_GENERATE_REPORT_CARD_NEW_WRITE", "Report cards for Grade $grade");
...
DEFINE('_CONTACT_MANAGE_GRADES_1_ADD_NOTE', 'Add Grades Note');
...
DEFINE('_ADMIN_TEACHER_2_SELECT', 'Select');
...
DEFINE('_ADMIN_SCHOOL_NAMES_FORM_ERROR', 'School cannot be removed, it\'s used in the system.');
...
DEFINE('_ADMIN_MANAGE_GRADES_1_ADD', 'Add Grade Note');
...
DEFINE('_ADMIN_CONF_CHANGE_YEAR_FORM_ERROR', 'That year has already been created.');
...
DEFINE('_ADMIN_CONFIG_LOGIN', 'Login Message (seen by every user)');
DEFINE('_ADMIN_CONFIG_TEACHERS', 'Message to Teachers');
DEFINE('_ADMIN_CONFIG_PARENTS', 'Message to Parents');
...
DEFINE('_ADMIN_CONFIG_DEF_UPDATE', 'Update Config');
