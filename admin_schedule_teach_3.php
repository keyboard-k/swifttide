...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_SCHEDULE_TEACH_3_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_SCHEDULE_TEACH_3_TITLE?></h1>
	<br>
...
action="admin_schedule_teach_4.php">
	  <tr class="trform">
	    <td width="35%">&nbsp;<?php echo _ADMIN_SCHEDULE_TEACH_3_SCHOOL?></td>
	    <td width="30%">&nbsp;<?php echo _ADMIN_SCHEDULE_TEACH_3_PERIOD?></td>
	    <td width="35%">&nbsp;<?php echo _ADMIN_SCHEDULE_TEACH_3_DAYS ?></td>
	  </tr>
	  <tr class="tblcont">
...
<? }; ?>
	  ...
	  <tr class="trform">
	    <td width="35%">&nbsp;<?php echo _ADMIN_SCHEDULE_TEACH_3_TERM?></td>
	    <td width="30%">&nbsp;<?php echo _ADMIN_SCHEDULE_TEACH_3_SUBJECT?></td>
	    <td width="35%">&nbsp;<?php echo _ADMIN_SCHEDULE_TEACH_3_ROOM?></td>
	  </tr>
	  <tr class="tblcont">
	    <td width="35%" class="tdinput">
		  <select name="term2">
