...
<TABLE id="mainTable">
	...
	<tr>
	<td><a href="teacher_manage_attendance_1.php?studentid=<?php echo  $studentid;  ?>" title="<?php echo _TEACHER_MENU_INC_PHP_ATTENDANCE ?>"><?php echo _TEACHER_MENU_INC_PHP_ATTENDANCE_TEXT ?></a></td>
	</tr>
	<tr>
	<td><a href="teacher_manage_discipline_1.php?studentid=<?php echo  $studentid;  ?>" title="<?php echo _TEACHER_MENU_INC_PHP_DISCIPLINE ?>"><?php echo _TEACHER_MENU_INC_PHP_DISCIPLINE_TEXT ?></a></td>
	</tr>
	<tr>
	<td><a href="teacher_manage_grades_1.php?studentid=<?php echo  $studentid;  ?>" title="<?php echo _TEACHER_MENU_INC_PHP_SINGLE ?>"><?php echo _TEACHER_MENU_INC_PHP_SINGLE_TEXT ?></a></td>
	</tr>
	<tr>
