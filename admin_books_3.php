...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_BOOKS_3_ADMIN_AREA?></td>
  </tr>
</table>
</div>

<div id="Content">
        <h1><?php echo _ADMIN_BOOKS_3_TITLE?></h1>
	<br>
	<h2><?php echo _ADMIN_BOOKS_3_SUBTITLE?></h2>
	<br>

<table cellpadding=0>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_ISBN . ":</b> " . $isbn;?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_BOOKTITLE . ":</b> " . $booktitle?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_BOOKPUBLISHER . ":</b> " . $bookpublisher?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_BOOKSUMMARY . ":</b> " . $booksummary?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_QUANTITY . ":</b> " . $quantity?></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_SENT_TO . ":</b> " . $admindata->tbl_admin_fname . " "
							    . $admindata->tbl_admin_lname?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_SENT_TO_EMAIL . ":</b> " . $admindata->tbl_admin_email?></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_SCHOOLNAME . ":</b> " . $schoolname?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_SCHOOLADDRESS . ":</b> " . $schooladdress?></td></tr>
  <tr><td><?php echo "<b>" . _ADMIN_BOOKS_3_SCHOOLADDRESS2 . ":</b> " . $schooladdress2?></td></tr>
</table>
