...
<table width="100%">
  <tr>
    ...
    <td width="50%"><?php echo _ADMIN_STUDENT_1_UPPER?></td>
  </tr>
</table>
</div>

<div id="Content">
	<h1><?php echo _ADMIN_STUDENT_1_TITLE?></h1>
	<br>
	<a href="admin_add_student_1.php" class="ahead"><?php echo _ADMIN_STUDENT_1_ADD_NEW?></a>
	<br>
	<h2><?php echo _ADMIN_STUDENT_1_SUBTITLE?></h2>
	<br>
	<table border="0" cellpadding="1" cellspacing="1" width="100%">
	  <tr>
	    <td width="100%" height="45">
	      <table border="1" cellpadding="0" cellspacing="0" width="100%">
	        <tr class="trform">
	          <td width="50%">&nbsp;<?php echo _ADMIN_STUDENT_1_BY_INTERNAL?></td>
	          <td width="50%">&nbsp;<?php echo _ADMIN_STUDENT_1_BY_NAME?></td>
		    </tr>
	        <tr>
			   <form name="srchid" method="POST" action="admin_student_2.php" onsubmit="return submitform('internalid', 0);">
		       <td width="50%" class="tdinput">
	           <input type="text" onChange="capitalizeMe(this)" name="internalid" size="22"><input type="submit" value="<?php echo _ADMIN_STUDENT_1_SEARCH?>" name="submit" class="frmbut">
		      ...
		      <td width="50%" class="tdinput">
		        <input type="text" onChange="capitalizeMe(this)" name="slname" size="25"><input type="submit" value="<?php echo _ADMIN_STUDENT_1_SEARCH?>" name="submit" class="frmbut">
	  ...
	  <tr>
	    <td width="100%" height="21">
	      <table border="1" cellpadding="0" cellspacing="0" width="100%">
		    <tr class="trform">
	          <td width="100%" colspan="4">&nbsp;<?php echo _ADMIN_STUDENT_1_OR_BY?></td>
	        </tr>
		    <tr>
			  <form name="srchall" method="POST" action="admin_student_2.php">
	          <td width="100%" class="tdinput" colspan="4">
			    <select size="1" name="school">
				   <option value="" selected=selected><?php echo _ADMIN_STUDENT_1_BY_SCHOOL?></option>
				   <?php
			    ...
			    <select name="grade">
				   <option value="" selected=selected><?php echo _ADMIN_STUDENT_1_BY_GRADE?></option>
				   <?php
			     ...
			     <select size="1" name="gender">
				    <option value="" selected=selected><?php echo _ADMIN_STUDENT_1_BY_GENDER?></option>
					<option value="<?php echo _MALE?>"><?php echo _MALE?></option>
					<option value="<?php echo _FEMALE?>"><?php echo _FEMALE?></option>
	             </select> 
			     <select size="1" name="ethnicity">
				   <option value="" selected=selected><?php echo _ADMIN_STUDENT_1_BY_ETHNICITY?></option>
				   <?php
	  ...
	  <tr>
	    <td width="100%">
	      <table border="1" cellpadding="0" cellspacing="0" width="100%">
		    <tr class="trform">
	          <td width="100%" colspan="4">&nbsp;<?php echo _ADMIN_STUDENT_1_BY_LAST?></td>
	        </tr>
			<tr>
